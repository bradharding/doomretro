...
* *DOOM Retro* is now built using v17.14.3 of [*Microsoft Visual Studio Community 2022*](https://visualstudio.microsoft.com/vs/community/).
* *DOOM Retro* now uses [*SDL v2.32.6*](https://github.com/libsdl-org/SDL/releases/tag/release-2.32.6), [*SDL_mixer v2.8.1*](https://github.com/libsdl-org/SDL_mixer/releases/tag/release-2.8.1) and [*SDL_image v2.8.8*](https://github.com/libsdl-org/SDL_image/releases/tag/release-2.8.8).
...
* The player’s controller now rumbles when they fall to the floor from a great height and the `joy_rumble_damage` CVAR is `on`.
