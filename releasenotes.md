...
* *DOOM Retro* is now compiled using v17.1.5 of [*Microsoft Visual Studio Community 2022*](https://www.visualstudio.com/vs/).
...
* The `map` CCMD can now be used to open the map <code>E<i>x</i>M<i>yy</i></code> where <code><i>yy</i></code> is between `10` and `99`.
