...
* The color of the console’s edge can now be changed using the new `con_edgecolor` CVAR, which can be `auto` (the default), or `0` to `255`. (The color of the *DOOM Retro* logo will now be inverted if the color chosen is bright enough.)
