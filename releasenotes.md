...
* *DOOM Retro* now uses [*SDL v2.24.0*](https://www.libsdl.org), [*SDL_mixer v2.6.1*](https://www.libsdl.org/SDL_mixer) and [*SDL_image v2.6.1*](https://www.libsdl.org/SDL_image).
