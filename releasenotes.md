...
* Minor changes have been made to the character set used in the console, the status bar, the marks in the automap, and the player messages when the alternate widescreen HUD is displayed.
* *DOOM Retro* will now automatically load `SIGIL_v1_21.wad` or `SIGIL_v1_2.wad` if found, in preference to `SIGIL.wad`.
