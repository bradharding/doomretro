...
* If the `+use` action is used against a wall that has a line special that requires it to be shot at instead, or has a scrolling or translucent texture, the player will now make an “oof” sound.
