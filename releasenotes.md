...
* Once the `condump` CCMD is used to dump the current contents of the console to a file, every line of text output to the console thereafter will continue to be dumped to that same file automatically.
