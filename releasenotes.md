...
* The player’s field of view can now be changed using the new `fov` CVAR. This CVAR can be a value between `80`° and `120`°, and is `90`° by default and when vanilla mode is enabled.
