...
* Displaying messages in the alternate font when the alternate HUD is displayed can now be toggled off using the new `r_altmessages` CVAR, which is `on` by default.
