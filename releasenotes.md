...
* *DOOM Retro* is now built using v17.7.2 of [*Microsoft Visual Studio Community 2022*](https://visualstudio.microsoft.com/vs/community/).
...
* The player’s crosshair is no longer visible in the background while the console is open.
