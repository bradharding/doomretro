...
* The tossing of items dropped by monsters when they are killed can now be toggled using the new `tossdrop` CVAR. (This CVAR is disabled when vanilla mode is on.)
