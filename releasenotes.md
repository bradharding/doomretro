...
* If the menu is opened while playing a game, the status bar or widescreen HUD will now be hidden, along with all sprites, and the player’s view will slowly rotate left or right.
