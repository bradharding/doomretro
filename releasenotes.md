...
* If the `+use` action is used against a wall that has a line special that requires it to be shot at instead, or has a scrolling texture, the player will make an “oof” sound.
