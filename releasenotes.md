...
* *DOOM Retro* is now built using v17.10.1 of [*Microsoft Visual Studio Community 2022*](https://visualstudio.microsoft.com/vs/community/).
...
* These changes have been made to the support for controllers:
  ...
  * Controllers no longer rumble if the mouse or keyboard is being used by the player instead.
