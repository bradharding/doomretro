...
* The player is now given double the ammo again when entering the `IDKFA` cheat.
...
* Timestamps are now only displayed in the console if they are at least one second after the previous one.
