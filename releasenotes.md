...
* If the menu is opened while playing a game, the status bar or widescreen HUD will now be hidden, along with the player’s weapon, and the player’s view will slowly rotate left or right.
