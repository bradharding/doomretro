...
* When entering a CCMD in the console that is only effective while playing a game, or while the player is alive, a description of the CCMD along a warning is now displayed.
