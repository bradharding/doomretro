...
* Support has been added for John Romero’s upcoming megawad [*SIGIL*](https://SI6IL.com/). When loading the *The Ultimate DOOM’s* IWAD from the WAD launcher, if `sigil.wad` is in the same folder, it will automatically be loaded and a fifth entry, “Sigil of Baphomet”, will then be available in the episode menu.
