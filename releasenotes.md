...
* Removing a behavior originally implemented in [*MBF*](https://doomwiki.org/wiki/MBF), monsters no longer back away if the player has their fists or chainsaw equipped and they get too close.
