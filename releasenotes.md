...
* *DOOM Retro* is now built using v17.6.5 of [*Microsoft Visual Studio Community 2022*](https://visualstudio.microsoft.com/vs/community/).
...
* The default of the `am_gridcolor` CVAR is now `5` instead of `111`.
