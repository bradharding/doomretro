...
* *DOOM Retro* now creates a folder called `autoload` in the same folder as `doomretro.exe`. Any PWADs placed in this folder will then always be automatically loaded at startup.
