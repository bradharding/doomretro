...
* *DOOM Retro* is now built using v17.5 of [*Microsoft Visual Studio Community 2022*](https://visualstudio.microsoft.com/vs/community/).
...
* These changes have been made to the alternate widescreen HUD:
  ...
  * All keycards and skull keys the player has picked up, as well as the amount of ammo, have been shifted upwards slightly.
