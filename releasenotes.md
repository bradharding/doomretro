...
* A subtle sound effect is now played when opening and closing the console using the <kbd>~</kbd> key.
* The console now scrolls down from the top of the screen when opened on the title screen.
