...
* Minor changes have been made to the character set used in the console, the status bar, and the player messages when the alternate widescreen HUD is displayed.
