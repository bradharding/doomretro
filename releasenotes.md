...
* The vertical position and translucency of player messages, as well as the current map’s title in the automap, have improved when the `vid_widescreen` CVAR is `on`.
