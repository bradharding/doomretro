...
#define SPLASHWIDTH         (NONWIDEWIDTH * 2)
#define SPLASHHEIGHT        (VANILLAHEIGHT * 4)
#define SPLASHACTUALHEIGHT  (SPLASHHEIGHT * 6 / 5)
#define NONWIDEASPECTRATIO  (4.0 / 3.0)

#define MAXWIDTH            (NONWIDEWIDTH * 6)
#define MAXHEIGHT           ((VANILLAHEIGHT + 1) * 4)
