...
{
    int x = players[0].mo->x >> FRACTOMAPBITS;
    int y = players[0].mo->y >> FRACTOMAPBITS;
...
static void AM_drawTransLineCharacter(mline_t *lineguy, int lineguylines, fixed_t scale, angle_t angle,
    byte *color, fixed_t x, fixed_t y)
{
    int i;
