...
typedef struct player_s
{
    ...
    int             shotssuccessful_incinerator;
    int             shotssuccessful_calamityblade;
    int             shotsfired[NUMWEAPONS];
    int             shotsfired_incinerator;
    int             shotsfired_calamityblade;
    int             deaths;
    int             suicides;
