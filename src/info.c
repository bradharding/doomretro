...
mobjinfo_t mobjinfo[] =
{
    ...
    // Revenant (MT_UNDEAD)
    {
        ...
        /* flags                */ (MF_SOLID | MF_SHOOTABLE | MF_COUNTKILL),
        /* flags2               */ (MF2_CASTSHADOW | MF2_CRUSHABLE | MF2_NOLIQUIDBOB | MF2_FOOTCLIP | MF2_MISSILEMORE),
    ...
    // Lost Soul (MT_SKULL)
    {
        ...
        /* activesound          */ sfx_dmact,
        /* flags                */ (MF_SOLID | MF_SHOOTABLE | MF_FLOAT | MF_NOGRAVITY | MF_COUNTKILL),
        /* flags2               */ (MF2_PASSMOBJ | MF2_CASTSHADOW | MF2_TRANSLUCENT_REDONLY | MF2_NOLIQUIDBOB | MF2_FOOTCLIP | MF2_MISSILEMORE),
        /* raisestate           */ S_NULL,
        /* frames               */ 0,
        /* fullbright           */ true,
        /* blood                */ 0,
