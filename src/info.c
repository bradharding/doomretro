...
mobjinfo_t mobjinfo[] =
{
    ...
    // Boss Brain Projectile (MT_SPAWNSHOT)
    {
        ...
        /* blood                */ 0,
        /* shadowoffset         */ 0,
        /* name1                */ "icon of sin's projectile",
        /* plural1              */ "",
        /* name2                */ "",
        /* plural2              */ "",
        /* name3                */ "",
