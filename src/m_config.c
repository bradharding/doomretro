...
static default_t cvars[] =
{
    ...
    STAT_INT_UNSIGNED (itemspickedup_ammo_bullets,       stat_itemspickedup_ammo_bullets,       stat_itemspickedup_ammo_bullets,     NOVALUEALIAS       ),
    ...
    STAT_INT_UNSIGNED (shotsfired_fists,                 stat_shotsfired_fists,                 stat_shotsfired_fists,               NOVALUEALIAS       ),
    STAT_INT_UNSIGNED (shotsfired_chainsaw,              stat_shotsfired_chainsaw,              stat_shotsfired_chainsaw,            NOVALUEALIAS       ),
    STAT_INT_UNSIGNED (shotsfired_pistol,                stat_shotsfired_pistol,                stat_shotsfired_pistol,              NOVALUEALIAS       ),
    STAT_INT_UNSIGNED (shotsfired_shotgun,               stat_shotsfired_shotgun,               stat_shotsfired_shotgun,             NOVALUEALIAS       ),
    STAT_INT_UNSIGNED (shotsfired_supershotgun,          stat_shotsfired_supershotgun,          stat_shotsfired_supershotgun,        NOVALUEALIAS       ),
    STAT_INT_UNSIGNED (shotsfired_chaingun,              stat_shotsfired_chaingun,              stat_shotsfired_chaingun,            NOVALUEALIAS       ),
    ...
    STAT_INT_UNSIGNED (shotssuccessful_shotgun,          stat_shotssuccessful_shotgun,          stat_shotssuccessful_shotgun,        NOVALUEALIAS       ),
    STAT_INT_UNSIGNED (shotssuccessful_supershotgun,     stat_shotssuccessful_supershotgun,     stat_shotssuccessful_supershotgun,   NOVALUEALIAS       ),
    STAT_INT_UNSIGNED (shotssuccessful_chaingun,         stat_shotssuccessful_chaingun,         stat_shotssuccessful_chaingun,       NOVALUEALIAS       ),
...
valuealias_t valuealiases[] =
{
    ...
    { "off",            0, BOOLVALUEALIAS      }, { "0",              0, BOOLVALUEALIAS      },
    { "false",          0, BOOLVALUEALIAS      }, { "no",             0, BOOLVALUEALIAS      },
    { "on",             1, BOOLVALUEALIAS      }, { "1",              1, BOOLVALUEALIAS      },
    { "true",           1, BOOLVALUEALIAS      }, { "yes",            1, BOOLVALUEALIAS      },
    ...
    { "man",            1, GENDERVALUEALIAS    }, { "female",         2, GENDERVALUEALIAS    },
    { "woman",          2, GENDERVALUEALIAS    }, { "off",            0, SUCKSVALUEALIAS     },
