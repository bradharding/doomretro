...
bool        r_corpses_fuzz = r_corpses_fuzz_default;
...
static default_t cvars[] =
{
    ...
    CVAR_BOOL         (r_corpses_fuzz,                   r_corpses_fuzz,                        r_corpses_fuzz,                      BOOLVALUEALIAS     ),
    ...
    CVAR_INT_UNSIGNED (gamesloaded,                      stat_gamesloaded,                      stat_gamesloaded,                    NOVALUEALIAS       ),
    ...
    CVAR_INT_UNSIGNED (mapsfinished,                     mapscompleted,                         stat_mapsfinished,                   NOVALUEALIAS       ),
