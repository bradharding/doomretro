...
uint64_t    stat_automapopened;
uint64_t    stat_barrelsexploded;
uint64_t    stat_cheated;
uint64_t    stat_damageinflicted;
uint64_t    stat_damagereceived;
uint64_t    stat_deaths;
uint64_t    stat_distancetraveled;
uint64_t    stat_gamessaved;
uint64_t    stat_itemspickedup;
uint64_t    stat_itemspickedup_ammo_bullets;
uint64_t    stat_itemspickedup_ammo_cells;
uint64_t    stat_itemspickedup_ammo_rockets;
uint64_t    stat_itemspickedup_ammo_shells;
uint64_t    stat_itemspickedup_armor;
uint64_t    stat_itemspickedup_health;
uint64_t    stat_mapscompleted;
uint64_t    stat_mapsstarted;
uint64_t    stat_monsterskilled;
uint64_t    stat_monsterskilled_infighting;
uint64_t    stat_monsterskilled_arachnotrons;
uint64_t    stat_monsterskilled_archviles;
uint64_t    stat_monsterskilled_baronsofhell;
uint64_t    stat_monsterskilled_cacodemons;
uint64_t    stat_monsterskilled_chaingunners;
uint64_t    stat_monsterskilled_cyberdemons;
uint64_t    stat_monsterskilled_hellknights;
uint64_t    stat_monsterskilled_imps;
uint64_t    stat_monsterskilled_lostsouls;
uint64_t    stat_monsterskilled_mancubi;
uint64_t    stat_monsterskilled_painelementals;
uint64_t    stat_monsterskilled_pinkydemons;
uint64_t    stat_monsterskilled_revenants;
uint64_t    stat_monsterskilled_shotgunguys;
uint64_t    stat_monsterskilled_spectres;
uint64_t    stat_monsterskilled_spidermasterminds;
uint64_t    stat_monsterskilled_zombiemen;
uint64_t    stat_monstersrespawned;
uint64_t    stat_monstersresurrected;
uint64_t    stat_monsterstelefragged;
uint64_t    stat_runs;
uint64_t    stat_secretsfound;
uint64_t    stat_shotsfired_fists;
uint64_t    stat_shotsfired_chainsaw;
uint64_t    stat_shotsfired_pistol;
uint64_t    stat_shotsfired_shotgun;
uint64_t    stat_shotsfired_supershotgun;
uint64_t    stat_shotsfired_chaingun;
uint64_t    stat_shotsfired_rocketlauncher;
uint64_t    stat_shotsfired_plasmarifle;
uint64_t    stat_shotsfired_bfg9000;
uint64_t    stat_shotssuccessful_fists;
uint64_t    stat_shotssuccessful_chainsaw;
uint64_t    stat_shotssuccessful_pistol;
uint64_t    stat_shotssuccessful_shotgun;
uint64_t    stat_shotssuccessful_supershotgun;
uint64_t    stat_shotssuccessful_chaingun;
uint64_t    stat_shotssuccessful_rocketlauncher;
uint64_t    stat_shotssuccessful_plasmarifle;
uint64_t    stat_shotssuccessful_bfg9000;
uint64_t    stat_skilllevel_imtooyoungtodie;
uint64_t    stat_skilllevel_heynottoorough;
uint64_t    stat_skilllevel_hurtmeplenty;
uint64_t    stat_skilllevel_ultraviolence;
uint64_t    stat_skilllevel_nightmare;
uint64_t    stat_suicides;
uint64_t    stat_timeplayed;
