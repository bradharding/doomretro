...
valuealias_t valuealiases[] =
{
    ...
    { "inverted",       r_invulnerabilityeffect_inverted, INVULNVALUEALIAS      },
    { "gray",           r_invulnerabilityeffect_gray,     INVULNVALUEALIAS      },
    { "grey",           r_invulnerabilityeffect_gray,     INVULNVALUEALIAS      },
