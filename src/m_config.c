...
bool        am_minimap = am_minimap_default;
...
bool        r_althud_ammocounts = r_althud_ammocounts_default;
...
#define COMMENT(text)                                   { text "\n", "",     NULL,  DEFAULT_OTHER,         0     }
#define BLANKLINE                                       { "",        "",     NULL,  DEFAULT_OTHER,         0     }
...
static default_t cvars[] =
{
    ...
    CVAR_INT          (am_allmapcdwallcolor,             am_allmapcdwallcolour,                 am_allmapcdwallcolor,                  0                     ),
    CVAR_INT          (am_allmapfdwallcolor,             am_allmapfdwallcolour,                 am_allmapfdwallcolor,                  0                     ),
    CVAR_INT          (am_allmapwallcolor,               am_allmapwallcolour,                   am_allmapwallcolor,                    0                     ),
    ...
    CVAR_INT          (am_backcolor,                     am_backcolour,                         am_backcolor,                          0                     ),
    CVAR_INT          (am_bloodsplatcolor,               am_bloodsplatcolour,                   am_bloodsplatcolor,                    0                     ),
    ...
    CVAR_INT          (am_display,                       am_display,                            am_display,                            0                     ),
    ...
    CVAR_INT          (am_markcolor,                     am_markcolour,                         am_markcolor,                          0                     ),
    CVAR_BOOL         (am_minimap,                       am_minimap,                            am_minimap,                            BOOLVALUEALIAS        ),
    CVAR_BOOL         (am_mousepanning,                  am_mousepanning,                       am_mousepanning,                       BOOLVALUEALIAS        ),
    CVAR_BOOL         (am_path,                          am_path,                               am_path,                               BOOLVALUEALIAS        ),
    CVAR_INT          (am_pathcolor,                     am_pathcolour,                         am_pathcolor,                          0                     ),
    CVAR_INT          (am_pathlength,                    am_pathlength,                         am_pathlength,                         PATHLENGTHVALUEALIAS  ),
    CVAR_INT          (am_playercolor,                   am_playercolour,                       am_playercolor,                        0                     ),
    CVAR_BOOL         (am_playerstats,                   am_playerstats,                        am_playerstats,                        BOOLVALUEALIAS        ),
    CVAR_INT          (am_playerstatscolor,              am_playerstatscolour,                  am_playerstatscolor,                   0                     ),
    CVAR_INT          (am_reddoorcolor,                  am_reddoorcolour,                      am_reddoorcolor,                       0                     ),
    ...
    CVAR_INT          (am_wallcolor,                     am_wallcolour,                         am_wallcolor,                          0                     ),
    CVAR_INT          (am_yellowdoorcolor,               am_yellowdoorcolour,                   am_yellowdoorcolor,                    0                     ),
    ...
    CVAR_INT_PERCENT  (joy_rumble_barrels,               gp_vibrate_barrels,                    joy_rumble_barrels,                    0                     ),
    CVAR_INT_PERCENT  (joy_rumble_damage,                gp_vibrate_damage,                     joy_rumble_damage,                     0                     ),
    ...
    CVAR_INT_PERCENT  (joy_rumble_weapons,               gp_vibrate_weapons,                    joy_rumble_weapons,                    0                     ),
    CVAR_FLOAT        (joy_sensitivity_horizontal,       gp_sensitivity_horizontal,             joy_sensitivity_horizontal,            0                     ),
    CVAR_FLOAT        (joy_sensitivity_vertical,         gp_sensitivity_vertical,               joy_sensitivity_vertical,              0                     ),
    CVAR_BOOL         (joy_swapthumbsticks,              gp_swapthumbsticks,                    joy_swapthumbsticks,                   BOOLVALUEALIAS        ),
    CVAR_INT          (joy_thumbsticks,                  gp_thumbsticks,                        joy_thumbsticks,                       0                     ),
    ...
    CVAR_INT_PERCENT  (movebob,                          movebob,                               movebob,                               0                     ),
    ...
    CVAR_BOOL         (r_althud_ammocounts,              r_althud_ammocounts,                   r_althud_ammocounts,                   BOOLVALUEALIAS        ),
    ...
    CVAR_INT          (r_bloodsplats_max,                r_bloodsplats_max,                     r_bloodsplats_max,                     0                     ),
    ...
    CVAR_INT          (r_screensize,                     r_screensize,                          r_screensize,                          0                     ),
    ...
    CVAR_STRING       (version,                          version,                               version,                               0                     ),
    CVAR_INT          (vid_aspectratio,                  vid_aspectratio,                       vid_aspectratio,                       RATIOVALUEALIAS       ),
    CVAR_INT_PERCENT  (vid_blue,                         vid_blue,                              vid_blue,                              0                     ),
...
#if !defined(_WIN32)
    CVAR_STRING       (vid_driver,                       vid_driver,                            vid_driver,                            0                     ),
#endif
    CVAR_BOOL         (vid_fullscreen,                   vid_fullscreen,                        vid_fullscreen,                        BOOLVALUEALIAS        ),
    CVAR_INT_PERCENT  (vid_green,                        vid_green,                             vid_green,                             0                     ),
    CVAR_INT_PERCENT  (vid_motionblur,                   vid_motionblur,                        vid_motionblur,                        0                     ),
    CVAR_BOOL         (vid_pillarboxes,                  vid_pillarboxes,                       vid_pillarboxes,                       BOOLVALUEALIAS        ),
    CVAR_INT_PERCENT  (vid_red,                          vid_red,                               vid_red,                               0                     ),
    CVAR_INT_PERCENT  (vid_saturation,                   vid_saturation,                        vid_saturation,                        0                     ),
    CVAR_STRING       (vid_scaleapi,                     vid_scaleapi,                          vid_scaleapi,                          0                     ),
    CVAR_STRING       (vid_scalefilter,                  vid_scalefilter,                       vid_scalefilter,                       0                     ),
    CVAR_OTHER        (vid_screenresolution,             vid_screenresolution,                  vid_screenresolution,                  0                     ),
    ...
    CVAR_OTHER        (vid_windowpos,                    vid_windowposition,                    vid_windowpos,                         0                     ),
    CVAR_OTHER        (vid_windowsize,                   vid_windowsize,                        vid_windowsize,                        0                     ),
#if defined(_WIN32)
    CVAR_STRING       (wad,                              wad,                                   wad,                                   0                     ),
#endif
    ...
    STAT_INT_UNSIGNED (damageinflicted,                  stat_damageinflicted,                  stat_damageinflicted,                  0                     ),
    STAT_INT_UNSIGNED (damagereceived,                   stat_damagereceived,                   stat_damagereceived,                   0                     ),
    STAT_INT_UNSIGNED (deaths,                           stat_deaths,                           stat_deaths,                           0                     ),
    STAT_INT_UNSIGNED (distancetraveled,                 stat_distancetraveled,                 stat_distancetraveled,                 0                     ),
    STAT_INT_UNSIGNED (firstrun,                         stat_firstrun,                         stat_firstrun,                         0                     ),
    STAT_INT_UNSIGNED (gamesloaded,                      stat_gamesloaded,                      stat_gamesloaded,                      0                     ),
    STAT_INT_UNSIGNED (gamessaved,                       stat_gamessaved,                       stat_gamessaved,                       0                     ),
    STAT_INT_UNSIGNED (itemspickedup,                    stat_itemspickedup,                    stat_itemspickedup,                    0                     ),
    STAT_INT_UNSIGNED (itemspickedup_ammo_bullets,       stat_itemspickedup_ammo_bullets,       stat_itemspickedup_ammo[am_clip],      0                     ),
    STAT_INT_UNSIGNED (itemspickedup_ammo_shells,        stat_itemspickedup_ammo_shells,        stat_itemspickedup_ammo[am_shell],     0                     ),
    STAT_INT_UNSIGNED (itemspickedup_ammo_rockets,       stat_itemspickedup_ammo_rockets,       stat_itemspickedup_ammo[am_misl],      0                     ),
    STAT_INT_UNSIGNED (itemspickedup_ammo_cells,         stat_itemspickedup_ammo_cells,         stat_itemspickedup_ammo[am_cell],      0                     ),
    STAT_INT_UNSIGNED (itemspickedup_ammo_fuel,          stat_itemspickedup_ammo_fuel,          stat_itemspickedup_ammo_fuel,          0                     ),
    STAT_INT_UNSIGNED (itemspickedup_armor,              stat_itemspickedup_armor,              stat_itemspickedup_armor,              0                     ),
    STAT_INT_UNSIGNED (itemspickedup_health,             stat_itemspickedup_health,             stat_itemspickedup_health,             0                     ),
    STAT_INT_UNSIGNED (itemspickedup_keys,               stat_itemspickedup_keys,               stat_itemspickedup_keys,               0                     ),
    STAT_INT_UNSIGNED (itemspickedup_powerups,           stat_itemspickedup_powerups,           stat_itemspickedup_powerups,           0                     ),
    STAT_INT_UNSIGNED (mapsfinished,                     mapscompleted,                         stat_mapsfinished,                     0                     ),
    STAT_INT_UNSIGNED (mapsstarted,                      stat_mapsstarted,                      stat_mapsstarted,                      0                     ),
    STAT_INT_UNSIGNED (monstersgibbed,                   stat_monstersgibbed,                   stat_monstersgibbed,                   0                     ),
    STAT_INT_UNSIGNED (monsterskilled,                   stat_monsterskilled,                   stat_monsterskilled_total,             0                     ),
    STAT_INT_UNSIGNED (monsterskilled_infighting,        stat_monsterskilled_infighting,        stat_monsterskilled_infighting,        0                     ),
    STAT_INT_UNSIGNED (monsterskilled_arachnotrons,      stat_monsterskilled_arachnotrons,      stat_monsterskilled[MT_BABY],          0                     ),
    STAT_INT_UNSIGNED (monsterskilled_archviles,         stat_monsterskilled_archviles,         stat_monsterskilled[MT_VILE],          0                     ),
    STAT_INT_UNSIGNED (monsterskilled_banshees,          stat_monsterskilled_banshees,          stat_monsterskilled[MT_BANSHEE],       0                     ),
    STAT_INT_UNSIGNED (monsterskilled_baronsofhell,      stat_monsterskilled_baronsofhell,      stat_monsterskilled[MT_BRUISER],       0                     ),
    STAT_INT_UNSIGNED (monsterskilled_cacodemons,        stat_monsterskilled_cacodemons,        stat_monsterskilled[MT_HEAD],          0                     ),
    STAT_INT_UNSIGNED (monsterskilled_chaingunners,      stat_monsterskilled_heavyweapondudes,  stat_monsterskilled[MT_CHAINGUY],      0                     ),
    STAT_INT_UNSIGNED (monsterskilled_cyberdemons,       stat_monsterskilled_cyberdemons,       stat_monsterskilled[MT_CYBORG],        0                     ),
    STAT_INT_UNSIGNED (monsterskilled_ghouls,            stat_monsterskilled_ghouls,            stat_monsterskilled[MT_GHOUL],         0                     ),
    STAT_INT_UNSIGNED (monsterskilled_hellknights,       stat_monsterskilled_hellknights,       stat_monsterskilled[MT_KNIGHT],        0                     ),
    STAT_INT_UNSIGNED (monsterskilled_imps,              stat_monsterskilled_imps,              stat_monsterskilled[MT_TROOP],         0                     ),
    STAT_INT_UNSIGNED (monsterskilled_lostsouls,         stat_monsterskilled_lostsouls,         stat_monsterskilled[MT_SKULL],         0                     ),
    STAT_INT_UNSIGNED (monsterskilled_mancubi,           stat_monsterskilled_mancubi,           stat_monsterskilled[MT_FATSO],         0                     ),
    STAT_INT_UNSIGNED (monsterskilled_mindweavers,       stat_monsterskilled_mindweavers,       stat_monsterskilled[MT_MINDWEAVER],    0                     ),
    STAT_INT_UNSIGNED (monsterskilled_painelementals,    stat_monsterskilled_painelementals,    stat_monsterskilled[MT_PAIN],          0                     ),
    STAT_INT_UNSIGNED (monsterskilled_pinkydemons,       stat_monsterskilled_demons,            stat_monsterskilled[MT_SERGEANT],      0                     ),
    STAT_INT_UNSIGNED (monsterskilled_revenants,         stat_monsterskilled_revenants,         stat_monsterskilled[MT_UNDEAD],        0                     ),
    STAT_INT_UNSIGNED (monsterskilled_shocktroopers,     stat_monsterskilled_shocktroopers,     stat_monsterskilled[MT_SHOCKTROOPER],  0                     ),
    STAT_INT_UNSIGNED (monsterskilled_shotgunguys,       stat_monsterskilled_shotgunguys,       stat_monsterskilled[MT_SHOTGUY],       0                     ),
    STAT_INT_UNSIGNED (monsterskilled_spectres,          stat_monsterskilled_spectres,          stat_monsterskilled[MT_SHADOWS],       0                     ),
    STAT_INT_UNSIGNED (monsterskilled_spidermasterminds, stat_monsterskilled_spidermasterminds, stat_monsterskilled[MT_SPIDER],        0                     ),
    STAT_INT_UNSIGNED (monsterskilled_tyrants,           stat_monsterskilled_tyrants,           stat_monsterskilled[MT_TYRANT],        0                     ),
    STAT_INT_UNSIGNED (monsterskilled_vassagos,          stat_monsterskilled_vassagos,          stat_monsterskilled[MT_VASSAGO],       0                     ),
    STAT_INT_UNSIGNED (monsterskilled_zombiemen,         stat_monsterskilled_zombiemen,         stat_monsterskilled[MT_POSSESSED],     0                     ),
    STAT_INT_UNSIGNED (monstersrespawned,                stat_monstersrespawned,                stat_monstersrespawned,                0                     ),
    STAT_INT_UNSIGNED (monstersresurrected,              stat_monstersresurrected,              stat_monstersresurrected,              0                     ),
    STAT_INT_UNSIGNED (monsterstelefragged,              stat_monsterstelefragged,              stat_monsterstelefragged,              0                     ),
    STAT_INT_UNSIGNED (runs,                             stat_runs,                             stat_runs,                             0                     ),
    STAT_INT_UNSIGNED (secretsfound,                     stat_secretsrevealed,                  stat_secretsfound,                     0                     ),
    STAT_INT_UNSIGNED (shotsfired_fists,                 stat_shotsfired_fists,                 stat_shotsfired[wp_fist],              0                     ),
    STAT_INT_UNSIGNED (shotsfired_chainsaw,              stat_shotsfired_chainsaw,              stat_shotsfired[wp_chainsaw],          0                     ),
    STAT_INT_UNSIGNED (shotsfired_pistol,                stat_shotsfired_pistol,                stat_shotsfired[wp_pistol],            0                     ),
    STAT_INT_UNSIGNED (shotsfired_shotgun,               stat_shotsfired_shotgun,               stat_shotsfired[wp_shotgun],           0                     ),
    STAT_INT_UNSIGNED (shotsfired_supershotgun,          stat_shotsfired_supershotgun,          stat_shotsfired[wp_supershotgun],      0                     ),
    STAT_INT_UNSIGNED (shotsfired_chaingun,              stat_shotsfired_chaingun,              stat_shotsfired[wp_chaingun],          0                     ),
    STAT_INT_UNSIGNED (shotsfired_rocketlauncher,        stat_shotsfired_rocketlauncher,        stat_shotsfired[wp_missile],           0                     ),
    STAT_INT_UNSIGNED (shotsfired_plasmarifle,           stat_shotsfired_plasmarifle,           stat_shotsfired[wp_plasma],            0                     ),
    STAT_INT_UNSIGNED (shotsfired_bfg9000,               stat_shotsfired_bfg9000,               stat_shotsfired[wp_bfg],               0                     ),
    STAT_INT_UNSIGNED (shotsfired_incinerator,           stat_shotsfired_incinerator,           stat_shotsfired_incinerator,           0                     ),
    STAT_INT_UNSIGNED (shotsfired_calamityblade,         stat_shotsfired_calamityblade,         stat_shotsfired_calamityblade,         0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_fists,            stat_shotssuccessful_fist,             stat_shotssuccessful[wp_fist],         0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_chainsaw,         stat_shotssuccessful_chainsaw,         stat_shotssuccessful[wp_chainsaw],     0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_pistol,           stat_shotssuccessful_pistol,           stat_shotssuccessful[wp_pistol],       0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_shotgun,          stat_shotssuccessful_shotgun,          stat_shotssuccessful[wp_shotgun],      0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_supershotgun,     stat_shotssuccessful_supershotgun,     stat_shotssuccessful[wp_supershotgun], 0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_chaingun,         stat_shotssuccessful_chaingun,         stat_shotssuccessful[wp_chaingun],     0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_rocketlauncher,   stat_shotssuccessful_rocketlauncher,   stat_shotssuccessful[wp_missile],      0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_plasmarifle,      stat_shotssuccessful_plasmarifle,      stat_shotssuccessful[wp_plasma],       0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_bfg9000,          stat_shotssuccessful_bfg9000,          stat_shotssuccessful[wp_bfg],          0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_incinerator,      stat_shotssuccessful_incinerator,      stat_shotssuccessful_incinerator,      0                     ),
    STAT_INT_UNSIGNED (shotssuccessful_calamityblade,    stat_shotssuccessful_calamityblade,    stat_shotssuccessful_calamityblade,    0                     ),
    STAT_INT_UNSIGNED (skilllevel_imtooyoungtodie,       stat_skilllevel_imtooyoungtodie,       stat_skilllevel_imtooyoungtodie,       0                     ),
    STAT_INT_UNSIGNED (skilllevel_heynottoorough,        stat_skilllevel_heynottoorough,        stat_skilllevel_heynottoorough,        0                     ),
    STAT_INT_UNSIGNED (skilllevel_hurtmeplenty,          stat_skilllevel_hurtmeplenty,          stat_skilllevel_hurtmeplenty,          0                     ),
    STAT_INT_UNSIGNED (skilllevel_ultraviolence,         stat_skilllevel_ultraviolence,         stat_skilllevel_ultraviolence,         0                     ),
    STAT_INT_UNSIGNED (skilllevel_nightmare,             stat_skilllevel_nightmare,             stat_skilllevel_nightmare,             0                     ),
    STAT_INT_UNSIGNED (suicides,                         stat_suicides,                         stat_suicides,                         0                     ),
    STAT_INT_UNSIGNED (timeplayed,                       stat_time,                             stat_timeplayed,                       0                     )
};
