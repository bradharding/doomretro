...
#define CONFIG_VARIABLE_INT(name, oldname, set)             { #name, #oldname, &name, DEFAULT_INT32,         set          }
#define CONFIG_VARIABLE_INT_UNSIGNED(name, oldname, set)    { #name, #oldname, &name, DEFAULT_UINT64,        set          }
#define CONFIG_VARIABLE_INT_PERCENT(name, oldname, set)     { #name, #oldname, &name, DEFAULT_INT32_PERCENT, set          }
#define CONFIG_VARIABLE_FLOAT(name, oldname, set)           { #name, #oldname, &name, DEFAULT_FLOAT,         set          }
#define CONFIG_VARIABLE_FLOAT_PERCENT(name, oldname, set)   { #name, #oldname, &name, DEFAULT_FLOAT_PERCENT, set          }
#define CONFIG_VARIABLE_STRING(name, oldname, set)          { #name, #oldname, &name, DEFAULT_STRING,        set          }
#define CONFIG_VARIABLE_OTHER(name, oldname, set)           { #name, #oldname, &name, DEFAULT_OTHER,         set          }
...
{
    COMMENT("; CVARs\n"),
    CONFIG_VARIABLE_INT          (alwaysrun,                             alwaysrun,                             BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (am_allmapcdwallcolor,                  am_allmapcdwallcolor,                  NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_allmapfdwallcolor,                  am_allmapfdwallcolor,                  NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_allmapwallcolor,                    am_allmapwallcolor,                    NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_backcolor,                          am_backcolor,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_cdwallcolor,                        am_cdwallcolor,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_crosshaircolor,                     am_crosshaircolor,                     NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_external,                           am_external,                           BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (am_fdwallcolor,                        am_fdwallcolor,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_followmode,                         am_followmode,                         BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (am_grid,                               am_grid,                               BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (am_gridcolor,                          am_gridcolor,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_OTHER        (am_gridsize,                           am_gridsize,                           NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_markcolor,                          am_markcolor,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_path,                               am_path,                               BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (am_pathcolor,                          am_pathcolor,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_playercolor,                        am_playercolor,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_rotatemode,                         am_rotatemode,                         BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (am_teleportercolor,                    am_teleportercolor,                    NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_thingcolor,                         am_thingcolor,                         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_tswallcolor,                        am_tswallcolor,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (am_wallcolor,                          am_wallcolor,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (autoaim,                               autoaim,                               BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (autoload,                              autoload,                              BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (autosave,                              autosave,                              BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (autotilt,                              autotilt,                              BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (autouse,                               autouse,                               BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (centerweapon,                          centerweapon,                          BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (con_backcolor,                         con_backcolor,                         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (con_edgecolor,                         con_edgecolor,                         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (con_obituaries,                        con_obituaries,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (crosshair,                             crosshair,                             CROSSHAIRVALUEALIAS),
    CONFIG_VARIABLE_INT          (crosshaircolor,                        crosshaircolor,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (episode,                               episode,                               NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (expansion,                             expansion,                             NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (facebackcolor,                         facebackcolor,                         FACEBACKVALUEALIAS ),
    CONFIG_VARIABLE_INT          (fade,                                  fade,                                  BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (gp_analog,                             gp_analog,                             BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_FLOAT_PERCENT(gp_deadzone_left,                      gp_deadzone_left,                      NOVALUEALIAS       ),
    CONFIG_VARIABLE_FLOAT_PERCENT(gp_deadzone_right,                     gp_deadzone_right,                     NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (gp_invertyaxis,                        gp_invertyaxis,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (gp_sensitivity_horizontal,             gp_sensitivity_horizontal,             NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (gp_sensitivity_vertical,               gp_sensitivity_vertical,               NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (gp_swapthumbsticks,                    gp_swapthumbsticks,                    BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (gp_thumbsticks,                        gp_thumbsticks,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_PERCENT  (gp_vibrate_barrels,                    gp_vibrate_barrels,                    NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_PERCENT  (gp_vibrate_damage,                     gp_vibrate_damage,                     NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_PERCENT  (gp_vibrate_weapons,                    gp_vibrate_weapons,                    NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (infighting,                            infighting,                            BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (infiniteheight,                        infiniteheight,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_STRING       (iwadfolder,                            iwadfolder,                            NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (m_acceleration,                        m_acceleration,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (m_doubleclick_use,                     m_doubleclick_use,                     BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (m_invertyaxis,                         m_invertyaxis,                         BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (m_novertical,                          m_novertical,                          BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (m_sensitivity,                         m_sensitivity,                         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (melt,                                  wipe,                                  BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (messages,                              messages,                              BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (mouselook,                             mouselook,                             BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT_PERCENT  (movebob,                               movebob,                               NOVALUEALIAS       ),
    CONFIG_VARIABLE_STRING       (playername,                            playername,                            NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (r_althud,                              r_althud,                              BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_berserkintensity,                    r_berserkintensity,                    NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (r_blood,                               r_blood,                               BLOODVALUEALIAS    ),
    CONFIG_VARIABLE_INT          (r_bloodsplats_max,                     r_bloodsplats_max,                     NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (r_bloodsplats_translucency,            r_bloodsplats_translucency,            BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_brightmaps,                          r_brightmaps,                          BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT_PERCENT  (r_color,                               r_color,                               NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (r_corpses_color,                       r_corpses_color,                       BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_corpses_gib,                         r_corpses_gib,                         BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_corpses_mirrored,                    r_corpses_mirrored,                    BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_corpses_moreblood,                   r_corpses_moreblood,                   BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_corpses_nudge,                       r_corpses_nudge,                       BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_corpses_slide,                       r_corpses_slide,                       BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_corpses_smearblood,                  r_corpses_smearblood,                  BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_detail,                              r_detail,                              DETAILVALUEALIAS   ),
    CONFIG_VARIABLE_INT          (r_diskicon,                            r_diskicon,                            BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_dither,                              r_dither,                              BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_fixmaperrors,                        r_fixmaperrors,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_fixspriteoffsets,                    r_fixspriteoffsets,                    BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_floatbob,                            r_floatbob,                            BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_fov,                                 r_fov,                                 NOVALUEALIAS       ),
    CONFIG_VARIABLE_FLOAT        (r_gamma,                               r_gamma,                               GAMMAVALUEALIAS    ),
    CONFIG_VARIABLE_INT          (r_graduallighting,                     r_graduallighting,                     BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_homindicator,                        r_homindicator,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_hud,                                 r_hud,                                 BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_hud_translucency,                    r_hud_translucency,                    BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_liquid_bob,                          r_liquid_bob,                          BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_liquid_clipsprites,                  r_liquid_clipsprites,                  BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_liquid_current,                      r_liquid_current,                      BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_liquid_lowerview,                    r_liquid_lowerview,                    BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_liquid_swirl,                        r_liquid_swirl,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_OTHER        (r_lowpixelsize,                        r_lowpixelsize,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (r_mirroredweapons,                     r_mirroredweapons,                     BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_playersprites,                       r_playersprites,                       BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_rockettrails,                        r_rockettrails,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_screensize,                          r_screensize,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (r_shadows,                             r_shadows,                             BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_shadows_translucency,                r_shadows_translucency,                BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_shake_barrels,                       r_shake_barrels,                       BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT_PERCENT  (r_shake_damage,                        r_shake_damage,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (r_skycolor,                            r_skycolor,                            SKYVALUEALIAS      ),
    CONFIG_VARIABLE_INT          (r_supersampling,                       r_supersampling,                       BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_textures,                            r_textures,                            BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (r_translucency,                        r_translucency,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (s_channels,                            s_channels,                            NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_PERCENT  (s_musicvolume,                         s_musicvolume,                         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (s_randommusic,                         s_randommusic,                         BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (s_randompitch,                         s_randompitch,                         BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT_PERCENT  (s_sfxvolume,                           s_sfxvolume,                           NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (s_stereo,                              s_stereo,                              BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (savegame,                              savegame,                              NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (skilllevel,                            skilllevel,                            NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_PERCENT  (stillbob,                              stillbob,                              NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (tossdrop,                              tossdrop,                              BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT_PERCENT  (turbo,                                 turbo,                                 NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (units,                                 units,                                 UNITSVALUEALIAS    ),
    CONFIG_VARIABLE_STRING       (version,                               version,                               NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (vid_borderlesswindow,                  vid_borderlesswindow,                  BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (vid_capfps,                            vid_capfps,                            CAPVALUEALIAS      ),
    CONFIG_VARIABLE_INT          (vid_display,                           vid_display,                           NOVALUEALIAS       ),
#if !defined(_WIN32)
    CONFIG_VARIABLE_STRING       (vid_driver,                            vid_driver,                            NOVALUEALIAS       ),
#endif
    CONFIG_VARIABLE_INT          (vid_fullscreen,                        vid_fullscreen,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT_PERCENT  (vid_motionblur,                        vid_motionblur,                        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (vid_pillarboxes,                       vid_pillarboxes,                       BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_STRING       (vid_scaleapi,                          vid_scaleapi,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_STRING       (vid_scalefilter,                       vid_scalefilter,                       NOVALUEALIAS       ),
    CONFIG_VARIABLE_OTHER        (vid_screenresolution,                  vid_screenresolution,                  NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (vid_showfps,                           vid_showfps,                           BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (vid_vsync,                             vid_vsync,                             VSYNCVALUEALIAS    ),
    CONFIG_VARIABLE_INT          (vid_widescreen,                        vid_widescreen,                        BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_OTHER        (vid_windowpos,                         vid_windowpos,                         NOVALUEALIAS       ),
    CONFIG_VARIABLE_OTHER        (vid_windowsize,                        vid_windowsize,                        NOVALUEALIAS       ),
#if defined(_WIN32)
    CONFIG_VARIABLE_STRING       (wad,                                   wad,                                   NOVALUEALIAS       ),
#endif
    CONFIG_VARIABLE_INT          (warninglevel,                          warninglevel,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_PERCENT  (weaponbob,                             weaponbob,                             NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT          (weaponbounce,                          weaponbounce,                          BOOLVALUEALIAS     ),
    CONFIG_VARIABLE_INT          (weaponrecoil,                          weaponrecoil,                          BOOLVALUEALIAS     ),
    BLANKLINE,
    COMMENT("; player stats\n"),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_barrelsexploded,                  stat_barrelsexploded,                  NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_cheated,                          stat_cheated,                          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_damageinflicted,                  stat_damageinflicted,                  NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_damagereceived,                   stat_damagereceived,                   NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_deaths,                           stat_deaths,                           NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_distancetraveled,                 stat_distancetraveled,                 NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_gamessaved,                       stat_gamessaved,                       NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_itemspickedup,                    stat_itemspickedup,                    NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_itemspickedup_ammo_bullets,       stat_itemspickedup_ammo_bullets,       NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_itemspickedup_ammo_cells,         stat_itemspickedup_ammo_cells,         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_itemspickedup_ammo_rockets,       stat_itemspickedup_ammo_rockets,       NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_itemspickedup_ammo_shells,        stat_itemspickedup_ammo_shells,        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_itemspickedup_armor,              stat_itemspickedup_armor,              NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_itemspickedup_health,             stat_itemspickedup_health,             NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_mapscompleted,                    stat_mapscompleted,                    NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_mapsstarted,                      stat_mapsstarted,                      NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled,                   stat_monsterskilled,                   NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_arachnotrons,      stat_monsterskilled_arachnotrons,      NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_archviles,         stat_monsterskilled_archviles,         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_baronsofhell,      stat_monsterskilled_baronsofhell,      NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_cacodemons,        stat_monsterskilled_cacodemons,        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_cyberdemons,       stat_monsterskilled_cyberdemons,       NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_demons,            stat_monsterskilled_demons,            NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_heavyweapondudes,  stat_monsterskilled_heavyweapondudes,  NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_hellknights,       stat_monsterskilled_hellknights,       NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_imps,              stat_monsterskilled_imps,              NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_lostsouls,         stat_monsterskilled_lostsouls,         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_mancubi,           stat_monsterskilled_mancubi,           NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_painelementals,    stat_monsterskilled_painelementals,    NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_revenants,         stat_monsterskilled_revenants,         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_shotgunguys,       stat_monsterskilled_shotgunguys,       NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_spectres,          stat_monsterskilled_spectres,          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_spidermasterminds, stat_monsterskilled_spidermasterminds, NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_monsterskilled_zombiemen,         stat_monsterskilled_zombiemen,         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_runs,                             stat_runs,                             NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_secretsfound,                     stat_secretsrevealed,                  NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotsfired_pistol,                stat_shotsfired_pistol,                NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotsfired_shotgun,               stat_shotsfired_shotgun,               NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotsfired_supershotgun,          stat_shotsfired_supershotgun,          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotsfired_chaingun,              stat_shotsfired_chaingun,              NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotsfired_rocketlauncher,        stat_shotsfired_rocketlauncher,        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotsfired_plasmarifle,           stat_shotsfired_plasmarifle,           NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotsfired_bfg9000,               stat_shotsfired_bfg9000,               NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotssuccessful_pistol,           stat_shotssuccessful_pistol,           NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotssuccessful_shotgun,          stat_shotssuccessful_shotgun,          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotssuccessful_supershotgun,     stat_shotssuccessful_supershotgun,     NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotssuccessful_chaingun,         stat_shotssuccessful_chaingun,         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotssuccessful_rocketlauncher,   stat_shotssuccessful_rocketlauncher,   NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotssuccessful_plasmarifle,      stat_shotssuccessful_plasmarifle,      NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_shotssuccessful_bfg9000,          stat_shotssuccessful_bfg9000,          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_skilllevel_heynottoorough,        stat_skilllevel_heynottoorough,        NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_skilllevel_hurtmeplenty,          stat_skilllevel_hurtmeplenty,          NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_skilllevel_imtooyoungtodie,       stat_skilllevel_imtooyoungtodie,       NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_skilllevel_nightmare,             stat_skilllevel_nightmare,             NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_skilllevel_ultraviolence,         stat_skilllevel_ultraviolence,         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_suicides,                         stat_suicides,                         NOVALUEALIAS       ),
    CONFIG_VARIABLE_INT_UNSIGNED (stat_time,                             stat_time,                             NOVALUEALIAS       )
};
