...
static void R_InitSpriteLumps(void)
{
    ...
    if (FREEDOOM)
    {
        ...
        M_StringCopy(mobjinfo[MT_HEADSHOT].name1, "trilobite projectile", sizeof(mobjinfo[0].name1));
        M_StringCopy(mobjinfo[MT_HEADSHOT].plural1, "trilobite projectiles", sizeof(mobjinfo[0].plural1));
        ...
        M_StringCopy(mobjinfo[MT_BRUISERSHOT].name1, "pain bringer projectile", sizeof(mobjinfo[0].name1));
        M_StringCopy(mobjinfo[MT_BRUISERSHOT].plural1, "pain bringer projectiles", sizeof(mobjinfo[0].plural1));
        ...
        M_StringCopy(mobjinfo[MT_MISC61].name1, "dead trilobite", sizeof(mobjinfo[0].name1));
        M_StringCopy(mobjinfo[MT_MISC61].plural1, "dead trilobites", sizeof(mobjinfo[0].plural1));
        M_StringCopy(mobjinfo[MT_MISC63].name1, "dead zombie", sizeof(mobjinfo[0].name1));
        M_StringCopy(mobjinfo[MT_MISC63].plural1, "dead zombies", sizeof(mobjinfo[0].plural1));
        M_StringCopy(mobjinfo[MT_MISC64].name1, "dead flesh worm", sizeof(mobjinfo[0].name1));
        M_StringCopy(mobjinfo[MT_MISC64].plural1, "dead flesh worms", sizeof(mobjinfo[0].plural1));
        M_StringCopy(mobjinfo[MT_MISC66].name1, "dead serpentipede", sizeof(mobjinfo[0].name1));
        M_StringCopy(mobjinfo[MT_MISC66].plural1, "dead serpentipedes", sizeof(mobjinfo[0].plural1));
        M_StringCopy(mobjinfo[MT_MISC67].name1, "dead shotgun zombie", sizeof(mobjinfo[0].name1));
        M_StringCopy(mobjinfo[MT_MISC67].plural1, "dead shotgun zombies", sizeof(mobjinfo[0].plural1));
    }
    else if (hacx)
    {
