...
int keyboardinvleft = KEYINVLEFT_DEFAULT;
int keyboardinvright = KEYINVRIGHT_DEFAULT;
...
int keyboarduseartifact = KEYUSEARTIFACT_DEFAULT;
...
int gamepadinvleft = GAMEPADINVLEFT_DEFAULT;
int gamepadinvright = GAMEPADINVRIGHT_DEFAULT;
...
int gamepaduseartifact = GAMEPADUSEARTIFACT_DEFAULT;
