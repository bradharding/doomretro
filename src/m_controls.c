...
int keyboardprevmessage = KEYPREVMESSAGE_DEFAULT;
int keyboardprevmessage2 = KEYPREVMESSAGE2_DEFAULT;
...
int mouseprevmessage = MOUSEPREVMESSAGE_DEFAULT;
...
int controllerprevmessage = CONTROLLERPREVMESSAGE_DEFAULT;
