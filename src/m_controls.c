...
int keyboardlookcenter = KEYLOOKCENTER_DEFAULT;
int keyboardlookcenter2 = KEYLOOKCENTER2_DEFAULT;
int keyboardlookdown = KEYLOOKDOWN_DEFAULT;
int keyboardlookdown2 = KEYLOOKDOWN2_DEFAULT;
int keyboardlookup = KEYLOOKUP_DEFAULT;
int keyboardlookup2 = KEYLOOKUP2_DEFAULT;
int keyboardfreelook = KEYFREELOOK_DEFAULT;
int keyboardfreelook2 = KEYFREELOOK2_DEFAULT;
int keyboardfullzoom = KEYFULLZOOM_DEFAULT;
int keyboardfullzoom2 = KEYFULLZOOM2_DEFAULT;
...
int keyboardsizedown = KEYSIZEDOWN_DEFAULT;
int keyboardsizedown2 = KEYSIZEDOWN2_DEFAULT;
int keyboardsizeup = KEYSIZEUP_DEFAULT;
int keyboardsizeup2 = KEYSIZEUP2_DEFAULT;
...
int keyboardweapon1A = KEYWEAPON1A_DEFAULT;
int keyboardweapon1B = KEYWEAPON1B_DEFAULT;
int keyboardweapon2A = KEYWEAPON2A_DEFAULT;
int keyboardweapon2B = KEYWEAPON2B_DEFAULT;
int keyboardweapon3A = KEYWEAPON3A_DEFAULT;
int keyboardweapon3B = KEYWEAPON3B_DEFAULT;
int keyboardweapon4A = KEYWEAPON4A_DEFAULT;
int keyboardweapon4B = KEYWEAPON4B_DEFAULT;
int keyboardweapon5A = KEYWEAPON5A_DEFAULT;
int keyboardweapon5B = KEYWEAPON5B_DEFAULT;
int keyboardweapon6A = KEYWEAPON6A_DEFAULT;
int keyboardweapon6B = KEYWEAPON6B_DEFAULT;
int keyboardweapon7A = KEYWEAPON7A_DEFAULT;
int keyboardweapon7B = KEYWEAPON7B_DEFAULT;
...
int mouselookcenter = MOUSELOOKCENTER_DEFAULT;
int mouselookdown = MOUSELOOKDOWN_DEFAULT;
int mouselookup = MOUSELOOKUP_DEFAULT;
int mousefreelook = MOUSEFREELOOK_DEFAULT;
int mousefullzoom = MOUSEFULLZOOM_DEFAULT;
...
int mousesizedown = MOUSESIZEDOWN_DEFAULT;
int mousesizeup = MOUSESIZEUP_DEFAULT;
...
int controllerlookcenter = CONTROLLERLOOKCENTER_DEFAULT;
int controllerlookdown = CONTROLLERLOOKDOWN_DEFAULT;
int controllerlookup = CONTROLLERLOOKUP_DEFAULT;
int controllerfreelook = CONTROLLERFREELOOK_DEFAULT;
int controllerfullzoom = CONTROLLERFULLZOOM_DEFAULT;
...
int controllersizedown = CONTROLLERSIZEDOWN_DEFAULT;
int controllersizeup = CONTROLLERSIZEUP_DEFAULT;
