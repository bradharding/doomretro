...
int keyboardautomappandown = KEYAUTOMAPPANDOWN_DEFAULT;
int keyboardautomappanleft = KEYAUTOMAPPANLEFT_DEFAULT;
int keyboardautomappanright = KEYAUTOMAPPANRIGHT_DEFAULT;
int keyboardautomappanup = KEYAUTOMAPPANUP_DEFAULT;
