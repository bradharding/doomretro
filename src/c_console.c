...
const kern_t altkern[] =
{
    ...
    { 'o',  'j',  -2 }, { 'p',  '"',  -1 }, { 'P',  ',',  -1 }, { 'p',  ',',  -1 },
    { 'P',  '.',  -1 }, { 'P',  ';',  -1 }, { 'p',  ';',  -1 }, { 'p',  '\\', -1 },
    { 'P',  '_',  -1 }, { 'P',  'J',  -1 }, { 'p',  'j',  -2 }, { 'r',  ' ',  -1 },
    { 'r',  '"',  -1 }, { 'r',  ')',  -1 }, { 'r',  ',',  -2 }, { 'r',  '.',  -1 },
    { 'r',  '/',  -1 }, { 'r',  ';',  -1 }, { 'r',  '\\', -1 }, { 'r',  '_',  -1 },
    { 'r',  'a',  -1 }, { 'r',  'j',  -2 }, { 's',  ',',  -1 }, { 's',  ';',  -1 },
    { 's',  'j',  -2 }, { 'T',  ' ',  -1 }, { 'T',  ',',  -1 }, { 'T',  '.',  -1 },
    { 'T',  ';',  -1 }, { 'T',  'a',  -1 }, { 'T',  'e',  -1 }, { 't',  'j',  -2 },
    { 'T',  'o',  -1 }, { 't',  't',  -1 }, { 'u',  'j',  -2 }, { 'V',  ',',  -1 },
    { 'v',  ',',  -1 }, { 'V',  '.',  -1 }, { 'v',  '4',  -1 }, { 'V',  ';',  -1 },
    { 'v',  ';',  -1 }, { 'v',  '_',  -1 }, { 'V',  'a',  -1 }, { 'v',  'a',  -1 },
    { 'v',  'j',  -2 }, { 'w',  'j',  -2 }, { 'x',  '7',  -1 }, { 'x',  'j',  -2 },
    { 'Y',  ',',  -1 }, { 'Y',  '.',  -1 }, { 'Y',  ';',  -1 }, { 'z',  'j',  -2 },
    { '\0', '\0',  0 }
};
...
static void C_DrawBackground(void)
{
    ...
    // draw branding
    V_DrawConsoleBrandingPatch(SCREENWIDTH - MAXWIDESCREENDELTA - (vid_widescreen ? 69 : 44),
