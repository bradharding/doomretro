...
kern_t altkern[] =
{
    ...
    { '.',  '\\', -1 }, { '.',  '4',  -1 }, { '.',  '7',  -1 }, { ',',  '4',  -1 }, { ',',  '7',  -1 }, { '/',  '/',  -2 },
    { '/',  'a',  -1 }, { '/',  'd',  -1 }, { '/',  'o',  -1 }, { ':', '\\',  -1 }, { '_',  'f',  -1 }, { '(',  '(',  -1 },
    { ')',  '.',  -1 }, { ')',  ')',  -1 }, { '0',  ',',  -1 }, { '0',  ';',  -1 }, { '0',  'j',  -2 }, { '1',  '"',  -1 },
    { '1',  '\\', -1 }, { '1',  '\'', -1 }, { '1',  'j',  -2 }, { '2',  'j',  -2 }, { '3',  ',',  -1 }, { '3',  ';',  -1 },
    { '3',  'j',  -2 }, { '4',  'j',  -2 }, { '5',  ',',  -1 }, { '5',  ';',  -1 }, { '5',  'j',  -2 }, { '6',  ',',  -1 },
    { '6',  'j',  -2 }, { '7',  '.',  -2 }, { '7',  ',',  -2 }, { '7',  ';',  -1 }, { '7',  'j',  -2 }, { '8',  ',',  -1 },
    { '8',  ';',  -1 }, { '8',  'j',  -2 }, { '9',  ',',  -1 }, { '9',  ';',  -1 }, { '9',  'j',  -2 }, { 'F',  '.',  -1 },
    { 'F',  ',',  -1 }, { 'F',  ';',  -1 }, { 'L',  '\\', -1 }, { 'L',  '"',  -1 }, { 'L',  '\'', -1 }, { 'L',  'Y',  -1 },
    { 'P',  '.',  -1 }, { 'P',  ',',  -1 }, { 'P',  ';',  -1 }, { 'T',  ' ',  -1 }, { 'T',  '.',  -1 }, { 'T',  ',',  -1 },
    { 'T',  ';',  -1 }, { 'T',  'a',  -1 }, { 'T',  'e',  -1 }, { 'T',  'o',  -1 }, { 'V',  '.',  -1 }, { 'V',  ',',  -1 },
    { 'V',  ';',  -1 }, { 'Y',  '.',  -1 }, { 'Y',  ',',  -1 }, { 'Y',  ';',  -1 }, { 'a',  '"',  -1 }, { 'a',  '\\', -1 },
