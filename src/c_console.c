...
const kern_t altkern[] =
{
    ...
    { '\0', ' ',  ' ',  -1 }, { '.', ' ',  '(',  -20 }, { '\0', ' ',  '(',  -1 }, { '\0', ' ',  'J',  -1 },
    { '\0', ' ',  'T',  -1 }, { '\0', '!',  ' ',   2 }, { '\0', '"',  '+',  -1 }, { '\0', '"',  ',',  -2 },
    { '\0', '"',  '.',  -2 }, { '\0', '"',  '4',  -1 }, { '\0', '"',  'J',  -2 }, { '\0', '"',  'a',  -1 },
    { '\0', '"',  'c',  -1 }, { '\0', '"',  'd',  -1 }, { '\0', '"',  'e',  -1 }, { '\0', '"',  'g',  -1 },
    { '\0', '"',  'j',  -2 }, { '\0', '"',  'o',  -1 }, { '\0', '"',  'q',  -1 }, { '\0', '"',  's',  -1 },
    { '\0', '\'',  '4', -1 }, { '\0', '\'', 's',  -2 }, { '\0', '(',  '(',  -1 }, { '\0', '(',  '-',  -1 },
    { '\0', '(',  't',  -1 }, { '\0', ')',  ')',  -1 }, { '\0', '+',  'j',  -2 }, { '\0', ',',  '-',  -1 },
    { '\0', ',',  '4',  -1 }, { '\0', ',',  '7',  -1 }, { '\0', '-',  '3',  -1 }, { '\0', '.',  '"',  -1 },
    { '\0', '.',  '4',  -1 }, { '\0', '.',  '7',  -1 }, { '\0', '.',  '\\', -1 }, { '\0', '/',  '/',  -2 },
    { '\0', '/',  'a',  -2 }, { '\0', '/',  'd',  -1 }, { '\0', '/',  'o',  -1 }, { '\0', '0',  ',',  -1 },
    { '\0', '0',  ';',  -1 }, { '\0', '0',  'j',  -2 }, { '\0', '1',  ',',  -1 }, { '\0', '1',  '"',  -1 },
    { '\0', '1',  '\'', -1 }, { '\0', '1',  '\\', -1 }, { '\0', '1',  'j',  -2 }, { '\0', '2',  ',',  -1 },
    { '\0', '2',  'j',  -2 }, { '\0', '3',  ',',  -1 }, { '\0', '3',  ';',  -1 }, { '\0', '3',  'j',  -2 },
    { '\0', '4',  '.',  -1 }, { '\0', '4',  ',',  -1 }, { '\0', '4',  '"',  -1 }, { '\0', '4',  '\'', -1 },
    { '\0', '4',  '\\', -1 }, { '\0', '4',  ')',  -1 }, { '\0', '4',  '4',  -1 }, { '\0', '4',  '7',  -1 },
    { '\0', '4',  'j',  -2 }, { '\0', '5',  ',',  -1 }, { '\0', '5',  ';',  -1 }, { '\0', '5',  'j',  -2 },
    { '\0', '6',  ',',  -1 }, { '\0', '6',  'j',  -2 }, { '\0', '7',  ',',  -3 }, { '\0', '7',  '.',  -2 },
    { '\0', '7',  ';',  -1 }, { '\0', '7',  '4',  -1 }, { '\0', '7',  'j',  -2 }, { '\0', '8',  ',',  -1 },
    { '\0', '8',  ';',  -1 }, { '\0', '8',  'j',  -2 }, { '\0', '9',  ',',  -1 }, { '\0', '9',  ';',  -1 },
    { '\0', '9',  'j',  -2 }, { '\0', '?',  ' ',   2 }, { '\0', 'F',  ' ',  -1 }, { '\0', 'F',  ',',  -1 },
    { '\0', 'F',  '.',  -1 }, { '\0', 'F',  ';',  -1 }, { '\0', 'F',  'J',  -1 }, { '\0', 'F',  'a',  -1 },
    { '\0', 'F',  'e',  -1 }, { '\0', 'F',  'o',  -1 }, { '\0', 'L',  ' ',  -1 }, { '\0', 'L',  '"',  -1 },
    { '\0', 'L',  'Y',  -1 }, { '\0', 'L',  '\'', -1 }, { '\0', 'L',  '\\', -1 }, { '\0', 'P',  ',',  -1 },
    { '\0', 'P',  '.',  -1 }, { '\0', 'P',  ';',  -1 }, { '\0', 'P',  '_',  -1 }, { '\0', 'P',  'J',  -1 },
    { '\0', 'T',  ' ',  -1 }, { '\0', 'T',  ',',  -1 }, { '\0', 'T',  '.',  -1 }, { '\0', 'T',  ';',  -1 },
    { '\0', 'T',  'a',  -1 }, { '\0', 'T',  'e',  -1 }, { '\0', 'T',  'o',  -1 }, { '\0', 'V',  ',',  -1 },
    { '\0', 'V',  '.',  -1 }, { '\0', 'V',  ';',  -1 }, { '\0', 'V',  'a',  -1 }, { '\0', 'Y',  ',',  -1 },
    { '\0', 'Y',  '.',  -1 }, { '\0', 'Y',  ';',  -1 }, { '\0', '\'', 'J',  -2 }, { '\0', '\'', 'a',  -1 },
    { '\0', '\'', 'c',  -1 }, { '\0', '\'', 'd',  -1 }, { '\0', '\'', 'e',  -1 }, { '\0', '\'', 'g',  -1 },
    { '\0', '\'', 'j',  -2 }, { '\0', '\'', 'o',  -1 }, { '\0', '\'', 't',  -1 }, { '\0', '\\', 'T',  -1 },
    { '\0', '\\', 'V',  -2 }, { '\0', '\\', '\\', -2 }, { '\0', '\\', 't',  -1 }, { '\0', '\\', 'v',  -1 },
    { '\0', '_',  'f',  -1 }, { '\0', '_',  't',  -1 }, { '\0', '_',  'v',  -2 }, { '\0', 'a',  '"',  -1 },
    { '\0', 'a',  '\'', -1 }, { '\0', 'a',  '\\', -1 }, { '\0', 'a',  'j',  -2 }, { '\0', 'b',  '"',  -1 },
    { '\0', 'b',  ',',  -1 }, { '\0', 'b',  ';',  -1 }, { '\0', 'b',  '\'', -1 }, { '\0', 'b',  '\\', -1 },
    { '\0', 'b',  'j',  -2 }, { '\0', 'c',  '"',  -1 }, { '\0', 'c',  ',',  -1 }, { '\0', 'c',  ';',  -1 },
    { '\0', 'c',  '\'', -1 }, { '\0', 'c',  '\\', -1 }, { '\0', 'c',  'j',  -2 }, { '\0', 'd',  'j',  -2 },
    { '\0', 'e',  '"',  -1 }, { '\0', 'e',  '.',  -1 }, { '\0', 'e',  ',',  -1 }, { '\0', 'e',  '/',  -1 },
    { '\0', 'e',  ';',  -1 }, { '\0', 'e',  '\'', -1 }, { '\0', 'e',  '\\', -1 }, { '\0', 'e',  '_',  -1 },
    { '\0', 'e',  ')',  -1 }, { '\0', 'e',  'j',  -2 }, { '\0', 'f',  ' ',  -1 }, { '\0', 'f',  '.',  -1 },
    { '\0', 'f',  ',',  -1 }, { '\0', 'f',  ';',  -1 }, { '\0', 'f',  '_',  -1 }, { '\0', 'f',  'a',  -1 },
    { '\0', 'f',  'f',  -1 }, { '\0', 'f',  'j',  -2 }, { '\0', 'f',  't',  -1 }, { '\0', 'h',  '\\', -1 },
    { '\0', 'h',  'j',  -2 }, { '\0', 'i',  'j',  -2 }, { '\0', 'k',  'j',  -2 }, { '\0', 'l',  'j',  -2 },
    { '\0', 'm',  '"',  -1 }, { '\0', 'm',  '\'', -1 }, { '\0', 'm',  '\\', -1 }, { '\0', 'm',  'j',  -2 },
    { '\0', 'n',  '"',  -1 }, { '\0', 'n',  '\'', -1 }, { '\0', 'n',  '\\', -1 }, { '\0', 'n',  'j',  -2 },
    { '\0', 'o',  '"',  -1 }, { '\0', 'o',  ',',  -1 }, { '\0', 'o',  ';',  -1 }, { '\0', 'o',  '\'', -1 },
    { '\0', 'o',  '\\', -1 }, { '\0', 'o',  'j',  -2 }, { '\0', 'p',  '"',  -1 }, { '\0', 'p',  ',',  -1 },
    { '\0', 'p',  ';',  -1 }, { '\0', 'p',  '\'', -1 }, { '\0', 'p',  '\\', -1 }, { '\0', 'p',  'j',  -2 },
    { '\0', 'r',  ' ',  -1 }, { '\0', 'r',  '"',  -1 }, { '\0', 'r',  ')',  -1 }, { '\0', 'r',  ',',  -2 },
    { '\0', 'r',  '.',  -1 }, { '\0', 'r',  '/',  -1 }, { '\0', 'r',  ';',  -1 }, { '\0', 'r',  '\'', -1 },
    { '\0', 'r',  '\\', -1 }, { '\0', 'r',  '_',  -2 }, { '\0', 'r',  'a',  -1 }, { '\0', 'r',  'j',  -2 },
    { '\0', 's',  ',',  -1 }, { '\0', 's',  ';',  -1 }, { '\0', 's',  'j',  -2 }, { '\0', 't',  'j',  -2 },
    { '\0', 't',  't',  -1 }, { '\0', 'u',  'j',  -2 }, { '\0', 'v',  ',',  -1 }, { '\0', 'v',  ';',  -1 },
    { '\0', 'v',  'a',  -1 }, { '\0', 'v',  'j',  -2 }, { '\0', 'w',  'j',  -2 }, { '\0', 'x',  'j',  -2 },
    { '\0', 'z',  'j',  -2 }, { '\0', '\0', '\0',  0 }
};
    ...
    for (int i = 0; i < len; i++)
    {
        ...
        if (kerning)
        {
            for (int j = 0; altkern[j].char1; j++)
                if ((altkern[j].char1 == '\0' || prevletter2 == altkern[j].char1)
                    && prevletter == altkern[j].char2 && letter == altkern[j].char3)
                {
                    w += altkern[j].adjust;
                    break;
                }
