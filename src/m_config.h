...
#define MOUSEBFG9000_DEFAULT                0
#define MOUSECHAINGUN_DEFAULT               0
#define MOUSECHAINSAW_DEFAULT               0
#define MOUSECLEARMARK_DEFAULT              -1
#define MOUSECONSOLE_DEFAULT                -1
#define MOUSEFIRE_DEFAULT                   0
#define MOUSEFISTS_DEFAULT                  0
