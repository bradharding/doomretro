...
#define KEYAUTOMAPPANDOWN_DEFAULT               KEY_DOWNARROW
#define KEYAUTOMAPPANLEFT_DEFAULT               KEY_LEFTARROW
#define KEYAUTOMAPPANRIGHT_DEFAULT              KEY_RIGHTARROW
#define KEYAUTOMAPPANUP_DEFAULT                 KEY_UPARROW
