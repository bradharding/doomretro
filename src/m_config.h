...
extern bool     r_liquid_rocksprites;
...
extern int      weaponcarouselbordercolor;
extern int      weaponcarouselcolor;
extern int      weaponcarouselhighlightcolor;
...
#define r_liquid_rocksprites_default            true
...
#define weaponcarouselbordercolor_auto          -1
#define weaponcarouselbordercolor_min           weaponcarouselbordercolor_auto
#define weaponcarouselbordercolor_default       weaponcarouselbordercolor_auto
#define weaponcarouselbordercolor_max           255
...
#define weaponcarouselhighlightcolor_auto       -1
#define weaponcarouselhighlightcolor_min        weaponcarouselhighlightcolor_auto
#define weaponcarouselhighlightcolor_default    weaponcarouselhighlightcolor_auto
#define weaponcarouselhighlightcolor_max        255
