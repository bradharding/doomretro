...
#define GAMEPADAUTOMAP_DEFAULT                  GAMECONTROLLER_BACK
...
#define GAMEPADAUTOMAPZOOMIN_DEFAULT            GAMECONTROLLER_RIGHT_SHOULDER
#define GAMEPADAUTOMAPZOOMOUT_DEFAULT           GAMECONTROLLER_LEFT_SHOULDER
#define GAMEPADBACK_DEFAULT                     0
#define GAMEPADCONSOLE_DEFAULT                  0
#define GAMEPADFIRE_DEFAULT                     GAMECONTROLLER_RIGHT_TRIGGER
#define GAMEPADFORWARD_DEFAULT                  0
#define GAMEPADJUMP_DEFAULT                     0
#define GAMEPADLEFT_DEFAULT                     0
#define GAMEPADMENU_DEFAULT                     GAMECONTROLLER_START
#define GAMEPADMOUSELOOK_DEFAULT                0
#define GAMEPADNEXTWEAPON_DEFAULT               GAMECONTROLLER_B
#define GAMEPADPREVWEAPON_DEFAULT               GAMECONTROLLER_Y
#define GAMEPADRIGHT_DEFAULT                    0
#define GAMEPADRUN_DEFAULT                      GAMECONTROLLER_LEFT_TRIGGER
#define GAMEPADSTRAFE_DEFAULT                   0
#define GAMEPADSTRAFELEFT_DEFAULT               0
#define GAMEPADSTRAFERIGHT_DEFAULT              0
#define GAMEPADUSE_DEFAULT                      GAMECONTROLLER_A
#define GAMEPADUSE2_DEFAULT                     GAMECONTROLLER_RIGHT_THUMB
