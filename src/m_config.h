...
#define GAMEPADLEFTDEADZONE_MIN         0
#define GAMEPADLEFTDEADZONE_DEFAULT     XINPUT_GAMEPAD_LEFT_THUMB_DEADZONE
#define GAMEPADLEFTDEADZONE_MAX         32767

#define GAMEPADRIGHTDEADZONE_MIN        0
#define GAMEPADRIGHTDEADZONE_DEFAULT    XINPUT_GAMEPAD_RIGHT_THUMB_DEADZONE
#define GAMEPADRIGHTDEADZONE_MAX        32767
