...
#define GAMECONTROLLERALWAYSRUN_DEFAULT         0
#define GAMECONTROLLERAUTOMAP_DEFAULT           GAMECONTROLLER_BACK
#define GAMECONTROLLERAUTOMAPCLEARMARK_DEFAULT  0
#define GAMECONTROLLERAUTOMAPFOLLOWMODE_DEFAULT 0
#define GAMECONTROLLERAUTOMAPGRID_DEFAULT       0
#define GAMECONTROLLERAUTOMAPMARK_DEFAULT       0
#define GAMECONTROLLERAUTOMAPMAXZOOM_DEFAULT    0
#define GAMECONTROLLERAUTOMAPROTATEMODE_DEFAULT 0
#define GAMECONTROLLERAUTOMAPZOOMIN_DEFAULT     GAMECONTROLLER_RIGHT_SHOULDER
#define GAMECONTROLLERAUTOMAPZOOMOUT_DEFAULT    GAMECONTROLLER_LEFT_SHOULDER
