...
linefix_t linefix[] =
{
   ...
   // mission,    episode, map, linedef, side, toptexture, middletexture, bottomtexture,  offset, rowoffset, flags,                     special,                                             tag
    ...
    { doom2,            1,  31,     666,    0, "",         "BRICK1",      "",                 25,   DEFAULT, DEFAULT,                   DEFAULT,                                         DEFAULT },
    { doom2,            1,  31,     667,    0, "",         "BRICK1",      "",            DEFAULT,   DEFAULT, DEFAULT,                   DEFAULT,                                         DEFAULT },
    { doom2,            1,  31,     668,    0, "",         "BRICK1",      "",                 25,   DEFAULT, DEFAULT,                   DEFAULT,                                         DEFAULT },
    { doom2,            1,  31,     669,    0, "",         "BRICK1",      "",            DEFAULT,   DEFAULT, DEFAULT,                   DEFAULT,                                         DEFAULT },
    { doom2,            1,  31,     670,    0, "",         "BRICK1",      "",                 25,   DEFAULT, DEFAULT,                   DEFAULT,                                         DEFAULT },
    { doom2,            1,  31,     671,    0, "",         "BRICK1",      "",            DEFAULT,   DEFAULT, DEFAULT,                   DEFAULT,                                         DEFAULT },
    { doom2,            1,  31,     672,    0, "",         "BRICK1",      "",                 25,   DEFAULT, DEFAULT,                   DEFAULT,                                         DEFAULT },
...
sectorfix_t sectorfix[] =
{
   // mission,    episode, map, sector, floorpic,  ceilingpic, floorheight, ceilingheight, special,                               tag
    ...
    { doom,             2,   5,    127, "",        "",             DEFAULT,       DEFAULT, DEFAULT,                               100 },
    ...
    { doom,             5,   4,     67, "",        "",             DEFAULT,       DEFAULT, Normal,                            DEFAULT },
    ...
    { doom2,            1,  12,    149, "",        "",             DEFAULT,       DEFAULT, DEFAULT,                                 0 },
    ...
    { doom2,            1,  21,     50, "",        "",             DEFAULT,           200, DEFAULT,                           DEFAULT },
    { doom2,            1,  21,     54, "",        "",             DEFAULT,           200, DEFAULT,                           DEFAULT },
    ...
    { pack_plut,        1,  10,     71, "",        "FLOOR7_1",     DEFAULT,       DEFAULT, DEFAULT,                           DEFAULT },
