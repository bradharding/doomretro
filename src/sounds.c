...
{
    { "",        "",        "",     "",                                "",                                ""            },
    { "e1m1",    "e1m1",    "",     "At DOOM's Gate",                  "At DOOM's Gate",                  ""            },
    { "e1m2",    "e1m2",    "",     "The Imp's Song",                  "The Imp's Song",                  ""            },
    { "e1m3",    "e1m3",    "",     "Dark Halls",                      "Dark Halls",                      ""            },
    { "e1m4",    "e1m4",    "",     "Kitchen Ace (And Taking Names)",  "Kitchen Ace (And Taking Names)",  ""            },
    { "e1m5",    "e1m5",    "",     "Suspense",                        "Suspense",                        ""            },
    { "e1m6",    "e1m6",    "",     "On The Hunt",                     "On The Hunt",                     ""            },
    { "e1m7",    "e1m7",    "",     "Demons On The Prey",              "Demons On The Prey",              ""            },
    { "e1m8",    "e1m8",    "",     "Sign Of Evil",                    "Sign Of Evil",                    ""            },
    { "e1m9",    "e1m9",    "",     "Hiding The Secrets",              "Hiding The Secrets",              ""            },
    { "e2m1",    "e2m1",    "",     "I Sawed The Demons",              "I Sawed The Demons",              ""            },
    { "e2m2",    "e2m2",    "",     "The Demons From Adrian's Pen",    "The Demons From Adrian's Pen",    ""            },
    { "e2m3",    "e2m3",    "",     "Intermission From DOOM",          "Intermission From DOOM",          ""            },
    { "e2m4",    "e2m4",    "",     "They're Going To Get You",        "They're Going To Get You",        ""            },
    { "e2m5",    "e2m5",    "",     "Demons On The Prey",              "Demons On The Prey",              ""            },
    { "e2m6",    "e2m6",    "",     "Sinister",                        "Sinister",                        ""            },
    { "e2m7",    "e2m7",    "",     "Waltz Of The Demons",             "Waltz Of The Demons",             ""            },
    { "e2m8",    "e2m8",    "",     "Nobody Told Me About id",         "Nobody Told Me About id",         ""            },
    { "e2m9",    "e2m9",    "",     "n/a",                             "n/a",                             ""            },
    { "e3m1",    "e3m1",    "e2m9", "n/a",                             "n/a",                             ""            },
    { "e3m2",    "e3m2",    "",     "Donna To The Rescue",             "Donna To The Rescue",             ""            },
    { "e3m3",    "e3m3",    "",     "Deep Into The Code",              "Deep Into The Code",              ""            },
    { "e3m4",    "e3m4",    "e1m8", "Sign Of Evil",                    "Sign Of Evil",                    ""            },
    { "e3m5",    "e3m5",    "e1m7", "Demons On The Prey",              "Demons On The Prey",              ""            },
    { "e3m6",    "e3m6",    "e1m5", "Suspense",                        "Suspense",                        ""            },
    { "e3m7",    "e3m7",    "e2m7", "Waltz Of The Demons",             "Waltz Of The Demons",             ""            },
    { "e3m8",    "e3m8",    "",     "Facing The Spider",               "Facing The Spider",               ""            },
    { "e3m9",    "e3m9",    "e1m9", "Hiding The Secrets",              "Hiding The Secrets",              ""            },
    { "e4m1",    "e4m1",    "e1m8", "n/a",                             "n/a",                             ""            },
    { "e4m2",    "e4m2",    "e3m2", "n/a",                             "n/a",                             ""            },
    { "e4m3",    "e4m3",    "e3m3", "n/a",                             "n/a",                             ""            },
    { "e4m4",    "e4m4",    "e1m5", "n/a",                             "n/a",                             ""            },
    { "e4m5",    "e4m5",    "e2m7", "n/a",                             "n/a",                             ""            },
    { "e4m6",    "e4m6",    "e2m4", "n/a",                             "n/a",                             ""            },
    { "e4m7",    "e4m7",    "e2m6", "n/a",                             "n/a",                             ""            },
    { "e4m8",    "e4m8",    "e2m5", "n/a",                             "n/a",                             ""            },
    { "e4m9",    "e4m9",    "e1m9", "n/a",                             "n/a",                             ""            },
    ...
    { "inter",   "inter",   "",     "Intermission From DOOM",          "Triceratoptron",                  "Extirpation" },
    { "intro",   "intro",   "",     "n/a",                             "Eye On Spiral Part 1",            "Immolator"   },
    { "bunny",   "bunny",   "",     "Sweet Little Dead Bunny",         "Sweet Little Dead Bunny",         ""            },
    { "victor",  "victor",  "",     "The End Of DOOM",                 "The End Of DOOM",                 ""            },
    { "introa",  "introa",  "",     "n/a",                             "n/a",                             ""            },
    { "runnin",  "runnin",  "",     "Running From Evil",               "Running From Evil",               ""            },
    { "stalks",  "stalks",  "",     "The Healer Stalks",               "The Healer Stalks",               ""            },
    { "countd",  "countd",  "",     "Countdown To Death",              "Countdown To Death",              ""            },
    { "betwee",  "betwee",  "",     "Between Levels",                  "Between Levels",                  ""            },
    { "doom",    "doom",    "",     "DOOM",                            "DOOM",                            ""            },
    { "the_da",  "the_da",  "",     "In The Dark",                     "In The Dark",                     ""            },
    { "shawn",   "shawn",   "",     "Shawn's Got The Shotgun",         "Shawn's Got The Shotgun",         ""            },
    { "ddtblu",  "ddtblu",  "",     "The Dave D. Taylor Blues",        "The Dave D. Taylor Blues",        ""            },
    { "in_cit",  "in_cit",  "",     "Into Sandy's City",               "Into Sandy's City",               ""            },
    { "dead",    "dead",    "",     "The Demon's Dead",                "The Demon's Dead",                ""            },
    { "stlks2",  "stlks2",  "",     "The Healer Stalks",               "The Healer Stalks",               ""            },
    { "theda2",  "theda2",  "",     "In The Dark",                     "In The Dark",                     ""            },
    { "doom2",   "doom2",   "",     "DOOM",                            "DOOM",                            ""            },
    { "ddtbl2",  "ddtbl2",  "",     "The Dave D. Taylor Blues",        "The Dave D. Taylor Blues",        ""            },
    { "runni2",  "runni2",  "",     "Running From Evil",               "Running From Evil",               ""            },
    { "dead2",   "dead2",   "",     "The Demon's Dead",                "The Demon's Dead",                ""            },
    { "stlks3",  "stlks3",  "",     "The Healer Stalks",               "The Healer Stalks",               ""            },
    { "romero",  "romero",  "",     "Waiting For Romero To Play",      "Waiting For Romero To Play",      ""            },
    { "shawn2",  "shawn2",  "",     "Shawn's Got The Shotgun",         "Shawn's Got The Shotgun",         ""            },
    { "messag",  "messag",  "",     "Message For The Arch-vile",       "Message For The Arch-vile",       ""            },
    { "count2",  "count2",  "",     "Countdown To Death",              "Countdown To Death",              ""            },
    { "ddtbl3",  "ddtbl3",  "",     "The Dave D. Taylor Blues",        "The Dave D. Taylor Blues",        ""            },
    { "ampie",   "ampie",   "",     "Bye Bye American Pie",            "Bye Bye American Pie",            ""            },
    { "theda3",  "theda3",  "",     "In The Dark",                     "In The Dark",                     ""            },
    { "adrian",  "adrian",  "",     "Adrian's Asleep",                 "Adrian's Asleep",                 ""            },
    { "messg2",  "messg2",  "",     "Message For The Arch-vile",       "Message For The Arch-vile",       ""            },
    { "romer2",  "romer2",  "",     "Waiting For Romero To Play",      "Waiting For Romero To Play",      ""            },
    { "tense",   "tense",   "",     "Getting Too Tense",               "Getting Too Tense",               ""            },
    { "shawn3",  "shawn3",  "",     "Shawn's Got The Shotgun",         "Shawn's Got The Shotgun",         ""            },
    { "openin",  "openin",  "",     "Opening To Hell",                 "Opening To Hell",                 ""            },
    { "evil",    "evil",    "",     "Evil Incarnate",                  "Evil Incarnate",                  ""            },
    { "ultima",  "ultima",  "",     "The Ultimate Challenge/Conquest", "The Ultimate Challenge/Conquest", ""            },
    { "read_m",  "read_m",  "",     "n/a",                             "n/a",                             ""            },
    { "dm2ttl",  "dm2ttl",  "",     "n/a",                             "n/a",                             ""            },
    { "dm2int",  "dm2int",  "",     "n/a",                             "n/a",                             ""            },
    { "",        "",        "",     "",                                "",                                ""            },
