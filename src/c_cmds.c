...
consolecmd_t consolecmds[] =
{
    ...
    CMD       (mapstats, C_GameCondition, C_MapStats, 0, "", "Shows statistics about the current map."),
    ...
    CMD       (playerstats, C_GameCondition, C_PlayerStats, 0, "", "Shows statistics about the player."),
