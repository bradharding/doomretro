...
consolecmd_t consolecmds[] =
{
    ...
    CVAR_BOOL(r_shake_explosion, "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS,
        "Toggles shaking the player’s view when they are near an explosion."),
    ...
    CCMD(teleport, "", teleport_cmd_func1, teleport_cmd_func2, true, TELEPORTCMDFORMAT,
        "Teleports the player to (" BOLDITALICS("x") "," BOLDITALICS("y") "," BOLDITALICS("z") ")."),
