...
consolecmd_t consolecmds[] =
{
    ...
    CVAR_INT(expansion, "", int_cvars_func1, expansion_cvar_func2, CF_NONE, NOVALUEALIAS,
        "The currently selected <i><b>DOOM II</b></i> expansion in the menu (<b>1</b> or <b>2</b>)."),
    ...
    CCMD(give, "", give_cmd_func1, give_cmd_func2, true, GIVECMDFORMAT,
        "Gives <b>ammo</b>, <b>armor</b>, <b>health</b>, <b>keys</b>, <b>weapons</b>, or <b>all</b> or certain <i>items</i> to the "
        "player."),
    ...
    CVAR_INT(gp_vibrate_barrels, "", int_cvars_func1, int_cvars_func2, CF_PERCENT, NOVALUEALIAS,
        "The amount <i><b>XInput</b></i> gamepads vibrate when the player is near an exploding barrel (<b>0%</b> to <b>200%</b>)."),
    CVAR_INT(gp_vibrate_damage, "", int_cvars_func1, int_cvars_func2, CF_PERCENT, NOVALUEALIAS,
        "The amount <i><b>XInput</b></i> gamepads vibrate when the player receives damage (<b>0%</b> to <b>200%</b>)."),
    CVAR_INT(gp_vibrate_weapons, "", int_cvars_func1, int_cvars_func2, CF_PERCENT, NOVALUEALIAS,
        "The amount <i><b>XInput</b></i> gamepads vibrate when the player fires their weapon (<b>0%</b> to <b>200%</b>)."),
    ...
    CCMD(if, "", null_func1, if_cmd_func2, true, IFCMDFORMAT,
        "Executes a string of <i>commands</i> if a <i>CVAR</i> equals a <i>value</i>."),
    ...
    CCMD(kill, explode, kill_cmd_func1, kill_cmd_func2, true, KILLCMDFORMAT,
        "Kills the <b>player</b>, <b>all</b> monsters, a type of <i>monster</i>, or explodes all <b>barrels</b> or <b>missiles</b>."),
    ...
    CCMD(name, "", name_cmd_func1, name_cmd_func2, true, NAMECMDFORMAT,
        "Gives a <i>name</i> to the <i>monster</i> nearest to the player."),
    ...
    CVAR_BOOL(r_dither, "", bool_cvars_func1, r_dither_cvar_func2, BOOLVALUEALIAS,
        "Toggles dithering of <i><b>BOOM</b></i>-compatible translucent wall textures."),
    CVAR_BOOL(r_fixmaperrors, "", bool_cvars_func1, r_fixmaperrors_cvar_func2, BOOLVALUEALIAS,
        "Toggles fixing the mapping errors in the <i><b>DOOM</b></i> and <i><b>DOOM II</b></i> IWADs."),
    ...
    CVAR_OTHER(r_lowpixelsize, "", null_func1, r_lowpixelsize_cvar_func2,
        "The size of each pixel when the graphic detail is low (<i>width</i><b>\xD7</b><i>height</i>)."),
    ...
    CVAR_BOOL(r_translucency, "", bool_cvars_func1, r_translucency_cvar_func2, BOOLVALUEALIAS,
        "Toggles the translucency of sprites and <i><b>BOOM</b></i>- compatible wall textures."),
    ...
    CCMD(take, "", take_cmd_func1, take_cmd_func2, true, TAKECMDFORMAT,
        "Takes <b>ammo</b>, <b>armor</b>, <b>health</b>, <b>keys</b>, <b>weapons</b>, or <b>all</b> or certain <i>items</i> from the "
        "player."),
    CCMD(teleport, "", teleport_cmd_func1, teleport_cmd_func2, true, TELEPORTCMDFORMAT,
        "Teleports the player to (<i>x</i>,<i>y</i>,<i>z</i>) in the current map."),
    ...
    CVAR_OTHER(vid_screenresolution, "", null_func1, vid_screenresolution_cvar_func2,
        "The screen's resolution when fullscreen (<b>desktop</b> or <i>width</i><b>\xD7</b><i>height</i>)."),
    ...
    CVAR_BOOL(weaponbounce, "", bool_cvars_func1, bool_cvars_func2, BOOLVALUEALIAS,
        "Toggles the bouncing of the player's weapon when dropping from a greater height."),
    CVAR_BOOL(weaponrecoil, "", bool_cvars_func1, bool_cvars_func2, BOOLVALUEALIAS,
        "Toggles the recoiling of the player's weapon when fired."),
...
static void C_ShowDescription(int index)
{
    ...
    if (consolecmds[index].type == CT_CCMD)
        C_OutputWrap("This CCMD %s", description);
    else
        C_OutputWrap("This CVAR %s%s",
