...
consolecmd_t consolecmds[] =
{
    ...
    CVAR_BOOL(r_altfont, "", bool_cvars_func1, bool_cvars_func2, CF_NONE, BOOLVALUEALIAS,
        "Toggles an alternate font for player messages and the current map's title in the automap."),
