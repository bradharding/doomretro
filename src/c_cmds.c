...
consolecmd_t consolecmds[] =
{
    ...
    CVAR_BOOL (r_liquid_lowerview, "", bool_cvars_func1, bool_cvars_func2, "Toggles lowering the player in liquid sectors."),
    ...
    CVAR_BOOL (s_randommusic, "", bool_cvars_func1, bool_cvars_func2, "Toggles the randomizing of the music at the start of each map."),
