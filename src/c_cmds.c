...
consolecmd_t consolecmds[] =
{
    ...
    CVAR_BOOL (mapfixes, C_BoolCondition, C_Bool, mapfixes, MAPFIXES, "Toggle whether fixes are applied to maps when they are loaded."),
    ...
    CVAR_BOOL (spritefixes, C_BoolCondition, C_Bool, spritefixes, SPRITEFIXES, "Toggle whether fixes are applied to sprites."),
    ...
    CVAR_BOOL (vid_capfps, C_BoolCondition, C_Bool, capfps, CAPFPS, "Toggle whether the framerate is capped at 35 FPS."),
#if defined(SDL20)
