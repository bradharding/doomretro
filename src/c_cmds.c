...
consolecmd_t consolecmds[] =
{
    ...
    CVAR_BOOL (m_doubleclick_use, "", bool_cvars_func1, bool_cvars_func2, "Toggles double-clicking a mouse button for the +use or +use2\nactions."),
    ...
    CVAR_BOOL (r_floatbob, "", bool_cvars_func1, bool_cvars_func2, "Toggles power-ups bobbing up and down."),
