...
action_t actions[] =
{
    { "+alwaysrun",    "Always Run",      &key_alwaysrun,          NULL,              &gamepadalwaysrun         },
    { "+automap",      "Automap",         &key_automap,            NULL,              &gamepadautomap           },
    { "+back",         "Move Back",       &key_down,               NULL,              NULL                      },
    { "+back2",        "Move Back",       &key_down2,              NULL,              NULL                      },
    { "+clearmark",    "Clear Mark",      &key_automap_clearmark,  NULL,              &gamepadautomapclearmark  },
    { "+console",      "Console",         &key_console,            NULL,              NULL                      },
    { "+fire",         "Fire",            &key_fire,               &mousebfire,       &gamepadfire              },
    { "+followmode",   "Follow Mode",     &key_automap_followmode, NULL,              &gamepadautomapfollowmode },
    { "+forward",      "Move Forward",    &key_up,                 &mousebforward,    NULL                      },
    { "+forward2",     "Move Forward",    &key_up2,                NULL,              NULL                      },
    { "+grid",         "Grid",            &key_automap_grid,       NULL,              &gamepadautomapgrid       },
    { "+left",         "Turn Left",       &key_left,               NULL,              NULL                      },
    { "+mark",         "Mark",            &key_automap_mark,       NULL,              &gamepadautomapmark       },
    { "+maxzoom",      "Max Zoom",        &key_automap_maxzoom,    NULL,              &gamepadautomapmaxzoom    },
    { "+menu",         "Menu",            &key_menu,               NULL,              &gamepadmenu              },
    { "+nextweapon",   "Next Weapon",     &key_nextweapon,         &mousebnextweapon, &gamepadnextweapon        },
    { "+prevweapon",   "Previous Weapon", &key_prevweapon,         &mousebprevweapon, &gamepadprevweapon        },
    { "+right",        "Turn Right",      &key_right,              NULL,              NULL                      },
    { "+rotatemode",   "Rotate Mode",     &key_automap_rotatemode, NULL,              &gamepadautomaprotatemode },
    { "+run",          "Run",             &key_run,                &mousebrun,        &gamepadrun               },
    { "+strafe",       "Strafe",          &key_strafe,             &mousebstrafe,     NULL                      },
    { "+strafeleft",   "Strafe Left",     &key_strafeleft,         NULL,              NULL                      },
    { "+strafeleft2",  "Strafe Left",     &key_strafeleft2,        NULL,              NULL                      },
    { "+straferight",  "Strafe Right",    &key_straferight,        NULL,              NULL                      },
    { "+straferight2", "Strafe Right",    &key_straferight2,       NULL,              NULL                      },
    { "+use",          "Use",             &key_use,                &mousebuse,        &gamepaduse               },
    { "+use2",         "Use",             &key_use2,               NULL,              NULL                      },
    { "+weapon1",      "Weapon Slot 1",   &key_weapon1,            NULL,              &gamepadweapon1           },
    { "+weapon2",      "Weapon Slot 2",   &key_weapon2,            NULL,              &gamepadweapon2           },
    { "+weapon3",      "Weapon Slot 3",   &key_weapon3,            NULL,              &gamepadweapon3           },
    { "+weapon4",      "Weapon Slot 4",   &key_weapon4,            NULL,              &gamepadweapon4           },
    { "+weapon5",      "Weapon Slot 5",   &key_weapon5,            NULL,              &gamepadweapon5           },
    { "+weapon6",      "Weapon Slot 6",   &key_weapon6,            NULL,              &gamepadweapon6           },
    { "+weapon7",      "Weapon Slot 7",   &key_weapon7,            NULL,              &gamepadweapon7           },
    { "+zoomin",       "Zoom In",         &key_automap_zoomin,     NULL,              &gamepadautomapzoomin     },
    { "+zoomout",      "Zoom Out",        &key_automap_zoomout,    NULL,              &gamepadautomapzoomout    },
    { "",              "",                NULL,                    NULL,              NULL                      }
};
