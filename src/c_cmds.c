...
action_t actions[] =
{
    ...
    { "+back",         &key_down,               &key_down2,        NULL,              NULL, &gamepadback,              NULL         },
    ...
    { "+forward",      &key_up,                 &key_up2,          &mousebforward,    NULL, &gamepadforward,           NULL         },
    { "+grid",         &key_automap_grid,       NULL,              NULL,              NULL, &gamepadautomapgrid,       NULL         },
    { "+left",         &key_left,               NULL,              NULL,              NULL, &gamepadleft,              NULL         },
    ...
    { "+right",        &key_right,              NULL,              NULL,              NULL, &gamepadright,             NULL         },
