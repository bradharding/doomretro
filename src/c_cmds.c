...
consolecmd_t consolecmds[] =
{
    ...
    CMD       (cmdlist, C_NoCondition, C_CmdList, 1, "[~searchstring~]", "Show a list of console commands."),
    CMD       (condump, C_NoCondition, C_ConDump, 1, "[~filename~.txt]", "Dump the console to a file."),
    CMD       (cvarlist, C_NoCondition, C_CvarList, 1, "[~searchstring~]", "Show a list of console variables."),
    ...
    CMD       (help, C_NoCondition, C_Help, 0, "", "Show the help screen."),
    ...
    CMD       (maplist, C_NoCondition, C_MapList, 0, "", "Show a list of the available maps."),
    ...
    CVAR_BOOL (r_liquid_bob, C_BoolCondition, C_Bool, animatedliquid, ANIMATEDLIQUID, "Toggle the bobbing effect of liquid sectors."),
    ...
    CVAR_BOOL (r_liquid_ripple, C_BoolCondition, C_Bool, swirlingliquid, ANIMATEDLIQUID, "Toggle the ripple effect of liquid sectors."),
    ...
    CMD       (thinglist, C_GameCondition, C_ThingList, 0, "", "Show a list of things in the current map."),
