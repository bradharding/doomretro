...
#define CONSOLEEDGECOLORCHEX1               114
#define CONSOLEEDGECOLORCHEX2               120
...
#define CONSOLETEXTPIXELWIDTH               (SCREENWIDTH - CONSOLETEXTX * 2 - (scrollbardrawn ? CONSOLESCROLLBARWIDTH + 18 : 10))
#define CONSOLEDIVIDERWIDTH                 (CONSOLETEXTPIXELWIDTH + 10)
#define CONSOLEHEADERWIDTH                  (CONSOLETEXTPIXELWIDTH + 10)
...
#define THINGLISTHEADER                     "\tTYPE\tDESCRIPTION\tPOSITION\tANGLE"
