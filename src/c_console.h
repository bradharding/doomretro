...
#define CONSOLETEXTX                        (vid_widescreen ? 34 : 10)
...
#define CONSOLETEXTPIXELWIDTH               (SCREENWIDTH - CONSOLETEXTX * 2 - (scrollbardrawn ? CONSOLESCROLLBARWIDTH + 5 : 0))
...
#define OVERLAYTEXTX                        (MAXWIDESCREENDELTA - 18)
