...
enum
{
    ...
    ScrollEast_Slow                                     = 21,
    ScrollEast_Medium                                   = 22,
    ScrollEast_Fast                                     = 23,
    ScrollNorth_Slow                                    = 26,
    ScrollNorth_Medium                                  = 27,
    ScrollNorth_Fast                                    = 28,
    ScrollSouth_Slow                                    = 31,
    ScrollSouth_Medium                                  = 32,
    ScrollSouth_Fast                                    = 33,
    ScrollWest_Slow                                     = 36,
    ScrollWest_Medium                                   = 37,
    ScrollWest_Fast                                     = 38,
    WindEast_Weak                                       = 40,
    WindEast_Medium                                     = 41,
    WindEast_Strong                                     = 42,
...
enum
{
    ...
    CrystalGeode                                       =    12,
    MaceSpheres                                        =    13,
    DiscipleOfDSparil                                  =    15,
    PileOfMaceSpheres                                  =    16,
    HangingSkull1                                      =    17,
    EtherealArrows                                     =    18,
    QuiverOfEtherealArrows                             =    19,
    LesserRunes                                        =    20,
    GreaterRunes                                       =    21,
    FlameOrb                                           =    22,
    InfernoOrb                                         =    23,
    ...
    WallTorch                                          =    50,
    HangingCorpse                                      =    51,
    TeleportGlitterExitBlue                            =    52,
    DragonClaw                                         =    53,
    ClawOrb                                            =    54,
    EnergyOrb                                          =    55,
    DSparilTeleportLocation                            =    56,
    UndeadWarrior                                      =    64,
    UndeadWarriorGhost                                 =    65,
    Gargoyle                                           =    66,
    Golem                                              =    68,
    GolemGhost                                         =    69,
    Weredragon                                         =    70,
    GreenKey                                           =    73,
    TeleportGlitterNormalRed                           =    74,
    Shadowsphere                                       =    75,
    FireBrazier                                        =    76,
    BlueKey                                            =    79,
    YellowKey                                          =    80,
    ...
    SequenceScream                                     =  1200,
    SequenceSquish                                     =  1201,
    SequenceWaterDrops                                 =  1202,
    SequenceSlowFootsteps                              =  1203,
    SequenceHeartbeat                                  =  1204,
    SequenceBells                                      =  1205,
    SequenceGrowl                                      =  1206,
    SequenceMagic                                      =  1207,
    SequenceLaughter                                   =  1208,
    SequenceFastFootsteps                              =  1209,
    EtherealCrossbow                                   =  2001,
    Firemace                                           =  2002,
    PhoenixRod                                         =  2003,
    Hellstaff                                          =  2004,
    GauntletsOfTheNecromancer                          =  2005,
    Gasbag                                             =  2035
};
