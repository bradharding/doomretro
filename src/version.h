...
#define DOOMRETRO_VERSION               6,1,1,0
#define DOOMRETRO_VERSIONSTRING         "6.1.1"
#define DOOMRETRO_NAMEANDVERSIONSTRING  "DOOM Retro v6.1.1"
...
#define DOOMRETRO_SAVEGAMEVERSIONSTRING DOOMRETRO_SAVEGAMEVERSION_6_0
