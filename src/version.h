...
#define DOOMRETRO_VERSION               6,4,0,0
#define DOOMRETRO_VERSIONSTRING         "6.4"
#define DOOMRETRO_NAMEANDVERSIONSTRING  "DOOM Retro v6.4"
...
#define DOOMRETRO_SAVEGAMEVERSION_6_4   "DOOM Retro v6.4"
#define DOOMRETRO_SAVEGAMEVERSIONSTRING DOOMRETRO_SAVEGAMEVERSION_6_4
