...
#define PACKAGE_VERSION                 2,4,5,0
#define PACKAGE_VERSIONSTRING           "2.4.5"
#define PACKAGE_NAMEANDVERSIONSTRING    "DOOM Retro v2.4.5"
#define PACKAGE_SAVEGAMEVERSIONSTRING   "DOOM Retro v2.4.5"
