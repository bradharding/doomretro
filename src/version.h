...
#define DOOMRETRO_VERSION               5,7,1,0
#define DOOMRETRO_VERSIONSTRING         "5.7.1"
#define DOOMRETRO_NAMEANDVERSIONSTRING  "DOOM Retro v5.7.1"
...
#define DOOMRETRO_SAVEGAMEVERSIONSTRING DOOMRETRO_SAVEGAMEVERSION_5_7_1
