...
#define DOOMRETRO_VERSION               5,0,6,0
#define DOOMRETRO_VERSIONSTRING         "5.0.6"
#define DOOMRETRO_NAMEANDVERSIONSTRING  "DOOM Retro v5.0.6"
...
#define DOOMRETRO_REPORTEMAIL           "mailto:brad@doomretro.com"
