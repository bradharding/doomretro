...
#define PACKAGE_VERSIONSTRING           "2.1.3"
#if defined (_DEBUG)
#define PACKAGE_BRANDINGSTRING          "DOOM Retro v2.1.3 (Debug Build)"
#else
#define PACKAGE_BRANDINGSTRING          "DOOM Retro v2.1.3"
#endif
#define PACKAGE_NAMEANDVERSIONSTRING    "DOOM Retro v2.1.3"
