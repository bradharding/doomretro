...
#define PACKAGE_VERSION                 2,5,1,0
#define PACKAGE_VERSIONSTRING           "2.5.1"
#define PACKAGE_NAMEANDVERSIONSTRING    "DOOM Retro v2.5.1"
#define PACKAGE_SAVEGAMEVERSIONSTRING   "DOOM Retro v2.5"
