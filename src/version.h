...
#define PACKAGE_VERSION                 1,8,4,0
#define PACKAGE_VERSIONSTRING           "1.8.4"
#if defined (_DEBUG)
#define PACKAGE_BRANDINGSTRING          "DOOM RETRO v1.8.4 (Debug Build)"
#else
#define PACKAGE_BRANDINGSTRING          "DOOM RETRO v1.8.4"
#endif
#define PACKAGE_NAMEANDVERSIONSTRING    "DOOM RETRO v1.8.4"
