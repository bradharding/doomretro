...
#define PACKAGE_VERSION                 1,8,3,0
#define PACKAGE_VERSIONSTRING           "1.8.3"
#if defined (_DEBUG)
#define PACKAGE_BRANDINGSTRING          "DOOM RETRO v1.8.3 (Debug Build)"
#else
#define PACKAGE_BRANDINGSTRING          "DOOM RETRO v1.8.3"
#endif
#define PACKAGE_NAMEANDVERSIONSTRING    "DOOM RETRO v1.8.3"
