...
#define PACKAGE_VERSION                     3,6,1,0
#define PACKAGE_VERSIONSTRING               "3.6.1"
#define PACKAGE_NAMEANDVERSIONSTRING        "DOOM Retro v3.6.1"
#define PACKAGE_SAVEGAMEVERSIONSTRING       "DOOM Retro v3.6"
#define PACKAGE_OLDSAVEGAMEVERSIONSTRING    "DOOM Retro v3.0"
