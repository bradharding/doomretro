...
#define PACKAGE_VERSION                 1,8,2,0
#define PACKAGE_VERSIONSTRING           "1.8.2"
#if defined (_DEBUG)
#define PACKAGE_BRANDINGSTRING          "DOOM RETRO v1.8.2 (Debug Build)"
#else
#define PACKAGE_BRANDINGSTRING          "DOOM RETRO v1.8.2"
#endif
#define PACKAGE_NAMEANDVERSIONSTRING    "DOOM RETRO v1.8.2"
#define PACKAGE_SAVEGAMEVERSIONSTRING   "DOOM RETRO v1.8"
