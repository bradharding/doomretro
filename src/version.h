...
#define DOOMRETRO_VERSION               5,6,3,0
#define DOOMRETRO_VERSIONSTRING         "5.6.3"
#define DOOMRETRO_NAMEANDVERSIONSTRING  "DOOM Retro v5.6.3"
#define DOOMRETRO_SAVEGAMEVERSION_3_6   "DOOM Retro v3.6"
#define DOOMRETRO_SAVEGAMEVERSION_5_6_3 "DOOM Retro v5.6.3"
#define DOOMRETRO_SAVEGAMEVERSIONSTRING DOOMRETRO_SAVEGAMEVERSION_5_6_3
