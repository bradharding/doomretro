...
state_t hereticstates[NUMHSTATES] = {
    ...
    {HSPR_INVS, 32768, 350, NULL, HS_ARTI_INVS1},   // HS_ARTI_INVS1
    ...
    {HSPR_FX01, 32772, 3, NULL, HS_EGGFXI1_2},      // HS_EGGFXI1_1
    {HSPR_FX01, 32773, 3, NULL, HS_EGGFXI1_3},      // HS_EGGFXI1_2
    {HSPR_FX01, 32774, 3, NULL, HS_EGGFXI1_4},      // HS_EGGFXI1_3
    {HSPR_FX01, 32775, 3, NULL, HS_NULL},   // HS_EGGFXI1_4
    {HSPR_SPHL, 0, 350, NULL, HS_ARTI_SPHL1},       // HS_ARTI_SPHL1
    {HSPR_TRCH, 32768, 3, NULL, HS_ARTI_TRCH2},     // HS_ARTI_TRCH1
    {HSPR_TRCH, 32769, 3, NULL, HS_ARTI_TRCH3},     // HS_ARTI_TRCH2
    {HSPR_TRCH, 32770, 3, NULL, HS_ARTI_TRCH1},     // HS_ARTI_TRCH3
    ...
    {HSPR_FBMB, 4, 6, NULL/*A_Scream*/, HS_FIREBOMB6},      // HS_FIREBOMB5
    {HSPR_XPL1, 32768, 4, NULL/*A_Explode*/, HS_FIREBOMB7}, // HS_FIREBOMB6
    {HSPR_XPL1, 32769, 4, NULL, HS_FIREBOMB8},      // HS_FIREBOMB7
    {HSPR_XPL1, 32770, 4, NULL, HS_FIREBOMB9},      // HS_FIREBOMB8
    {HSPR_XPL1, 32771, 4, NULL, HS_FIREBOMB10},     // HS_FIREBOMB9
    {HSPR_XPL1, 32772, 4, NULL, HS_FIREBOMB11},     // HS_FIREBOMB10
    {HSPR_XPL1, 32773, 4, NULL, HS_NULL},   // HS_FIREBOMB11
    ...
    {HSPR_PPOD, 32770, 5, NULL/*A_RemovePod*/, HS_POD_DIE2},        // HS_POD_DIE1
    {HSPR_PPOD, 32771, 5, NULL/*A_Scream*/, HS_POD_DIE3},   // HS_POD_DIE2
    {HSPR_PPOD, 32772, 5, NULL/*A_Explode*/, HS_POD_DIE4},  // HS_POD_DIE3
    {HSPR_PPOD, 32773, 10, NULL, HS_FREETARGMOBJ},  // HS_POD_DIE4
    ...
    {HSPR_LVAS, 32768, 5, NULL, HS_LAVASPLASH2},    // HS_LAVASPLASH1
    {HSPR_LVAS, 32769, 5, NULL, HS_LAVASPLASH3},    // HS_LAVASPLASH2
    {HSPR_LVAS, 32770, 5, NULL, HS_LAVASPLASH4},    // HS_LAVASPLASH3
    {HSPR_LVAS, 32771, 5, NULL, HS_LAVASPLASH5},    // HS_LAVASPLASH4
    {HSPR_LVAS, 32772, 5, NULL, HS_LAVASPLASH6},    // HS_LAVASPLASH5
    {HSPR_LVAS, 32773, 5, NULL, HS_NULL},   // HS_LAVASPLASH6
    {HSPR_LVAS, 32774, 5, NULL, HS_LAVASMOKE2},     // HS_LAVASMOKE1
    {HSPR_LVAS, 32775, 5, NULL, HS_LAVASMOKE3},     // HS_LAVASMOKE2
    {HSPR_LVAS, 32776, 5, NULL, HS_LAVASMOKE4},     // HS_LAVASMOKE3
    {HSPR_LVAS, 32777, 5, NULL, HS_LAVASMOKE5},     // HS_LAVASMOKE4
    {HSPR_LVAS, 32778, 5, NULL, HS_NULL},   // HS_LAVASMOKE5
    ...
    {HSPR_KFR1, 32768, 3, NULL, HS_FIREBRAZIER2},   // HS_FIREBRAZIER1
    {HSPR_KFR1, 32769, 3, NULL, HS_FIREBRAZIER3},   // HS_FIREBRAZIER2
    {HSPR_KFR1, 32770, 3, NULL, HS_FIREBRAZIER4},   // HS_FIREBRAZIER3
    {HSPR_KFR1, 32771, 3, NULL, HS_FIREBRAZIER5},   // HS_FIREBRAZIER4
    {HSPR_KFR1, 32772, 3, NULL, HS_FIREBRAZIER6},   // HS_FIREBRAZIER5
    {HSPR_KFR1, 32773, 3, NULL, HS_FIREBRAZIER7},   // HS_FIREBRAZIER6
    {HSPR_KFR1, 32774, 3, NULL, HS_FIREBRAZIER8},   // HS_FIREBRAZIER7
    {HSPR_KFR1, 32775, 3, NULL, HS_FIREBRAZIER1},   // HS_FIREBRAZIER8
    ...
    {HSPR_WTRH, 32768, 6, NULL, HS_WALLTORCH2},     // HS_WALLTORCH1
    ...
    {HSPR_KGZB, 32768, -1, NULL, HS_NULL},  // HS_KGZ_BLUEFLOAT1
    {HSPR_KGZG, 32768, -1, NULL, HS_NULL},  // HS_KGZ_GREENFLOAT1
    {HSPR_KGZY, 32768, -1, NULL, HS_NULL},  // HS_KGZ_YELLOWFLOAT1
    ...
    {HSPR_TGLT, 32768, 2, NULL, HS_TELEGLITTER1_2}, // HS_TELEGLITTER1_1
    {HSPR_TGLT, 32769, 2, NULL/*A_AccTeleGlitter*/, HS_TELEGLITTER1_3},     // HS_TELEGLITTER1_2
    {HSPR_TGLT, 32770, 2, NULL, HS_TELEGLITTER1_4}, // HS_TELEGLITTER1_3
    {HSPR_TGLT, 32771, 2, NULL/*A_AccTeleGlitter*/, HS_TELEGLITTER1_5},     // HS_TELEGLITTER1_4
    {HSPR_TGLT, 32772, 2, NULL, HS_TELEGLITTER1_1}, // HS_TELEGLITTER1_5
    {HSPR_TGLT, 32773, 2, NULL, HS_TELEGLITTER2_2}, // HS_TELEGLITTER2_1
    {HSPR_TGLT, 32774, 2, NULL/*A_AccTeleGlitter*/, HS_TELEGLITTER2_3},     // HS_TELEGLITTER2_2
    {HSPR_TGLT, 32775, 2, NULL, HS_TELEGLITTER2_4}, // HS_TELEGLITTER2_3
    {HSPR_TGLT, 32776, 2, NULL/*A_AccTeleGlitter*/, HS_TELEGLITTER2_5},     // HS_TELEGLITTER2_4
    {HSPR_TGLT, 32777, 2, NULL, HS_TELEGLITTER2_1}, // HS_TELEGLITTER2_5
    {HSPR_TELE, 32768, 6, NULL, HS_TFOG2},  // HS_TFOG1
    {HSPR_TELE, 32769, 6, NULL, HS_TFOG3},  // HS_TFOG2
    {HSPR_TELE, 32770, 6, NULL, HS_TFOG4},  // HS_TFOG3
    {HSPR_TELE, 32771, 6, NULL, HS_TFOG5},  // HS_TFOG4
    {HSPR_TELE, 32772, 6, NULL, HS_TFOG6},  // HS_TFOG5
    {HSPR_TELE, 32773, 6, NULL, HS_TFOG7},  // HS_TFOG6
    {HSPR_TELE, 32774, 6, NULL, HS_TFOG8},  // HS_TFOG7
    {HSPR_TELE, 32775, 6, NULL, HS_TFOG9},  // HS_TFOG8
    {HSPR_TELE, 32774, 6, NULL, HS_TFOG10}, // HS_TFOG9
    {HSPR_TELE, 32773, 6, NULL, HS_TFOG11}, // HS_TFOG10
    {HSPR_TELE, 32772, 6, NULL, HS_TFOG12}, // HS_TFOG11
    {HSPR_TELE, 32771, 6, NULL, HS_TFOG13}, // HS_TFOG12
    {HSPR_TELE, 32770, 6, NULL, HS_NULL},   // HS_TFOG13
    {HSPR_STFF, 0, 0, NULL/*A_Light0*/, HS_NULL},   // HS_LIGHTDONE
    {HSPR_STFF, 0, 1, NULL/*A_WeaponReady*/, HS_STAFFREADY},        // HS_STAFFREADY
    {HSPR_STFF, 0, 1, NULL/*A_Lower*/, HS_STAFFDOWN},       // HS_STAFFDOWN
    {HSPR_STFF, 0, 1, NULL/*A_Raise*/, HS_STAFFUP}, // HS_STAFFUP
    {HSPR_STFF, 3, 4, NULL/*A_WeaponReady*/, HS_STAFFREADY2_2},     // HS_STAFFREADY2_1
    {HSPR_STFF, 4, 4, NULL/*A_WeaponReady*/, HS_STAFFREADY2_3},     // HS_STAFFREADY2_2
    {HSPR_STFF, 5, 4, NULL/*A_WeaponReady*/, HS_STAFFREADY2_1},     // HS_STAFFREADY2_3
    {HSPR_STFF, 3, 1, NULL/*A_Lower*/, HS_STAFFDOWN2},      // HS_STAFFDOWN2
    {HSPR_STFF, 3, 1, NULL/*A_Raise*/, HS_STAFFUP2},        // HS_STAFFUP2
    {HSPR_STFF, 1, 6, NULL, HS_STAFFATK1_2},        // HS_STAFFATK1_1
    {HSPR_STFF, 2, 8, NULL/*A_StaffAttackPL1*/, HS_STAFFATK1_3},    // HS_STAFFATK1_2
    {HSPR_STFF, 1, 8, NULL/*A_ReFire*/, HS_STAFFREADY},     // HS_STAFFATK1_3
    {HSPR_STFF, 6, 6, NULL, HS_STAFFATK2_2},        // HS_STAFFATK2_1
    {HSPR_STFF, 7, 8, NULL/*A_StaffAttackPL2*/, HS_STAFFATK2_3},    // HS_STAFFATK2_2
    {HSPR_STFF, 6, 8, NULL/*A_ReFire*/, HS_STAFFREADY2_1},  // HS_STAFFATK2_3
    {HSPR_PUF3, 32768, 4, NULL, HS_STAFFPUFF2},     // HS_STAFFPUFF1
    ...
    {HSPR_PUF4, 32768, 4, NULL, HS_STAFFPUFF2_2},   // HS_STAFFPUFF2_1
    {HSPR_PUF4, 32769, 4, NULL, HS_STAFFPUFF2_3},   // HS_STAFFPUFF2_2
    {HSPR_PUF4, 32770, 4, NULL, HS_STAFFPUFF2_4},   // HS_STAFFPUFF2_3
    {HSPR_PUF4, 32771, 4, NULL, HS_STAFFPUFF2_5},   // HS_STAFFPUFF2_4
    {HSPR_PUF4, 32772, 4, NULL, HS_STAFFPUFF2_6},   // HS_STAFFPUFF2_5
    {HSPR_PUF4, 32773, 4, NULL, HS_NULL},   // HS_STAFFPUFF2_6
    {HSPR_BEAK, 0, 1, NULL/*A_BeakReady*/, HS_BEAKREADY},   // HS_BEAKREADY
    {HSPR_BEAK, 0, 1, NULL/*A_Lower*/, HS_BEAKDOWN},        // HS_BEAKDOWN
    ...
    {HSPR_GAUN, 0, 1, NULL/*A_WeaponReady*/, HS_GAUNTLETREADY},     // HS_GAUNTLETREADY
    {HSPR_GAUN, 0, 1, NULL/*A_Lower*/, HS_GAUNTLETDOWN},    // HS_GAUNTLETDOWN
    {HSPR_GAUN, 0, 1, NULL/*A_Raise*/, HS_GAUNTLETUP},      // HS_GAUNTLETUP
    {HSPR_GAUN, 6, 4, NULL/*A_WeaponReady*/, HS_GAUNTLETREADY2_2},  // HS_GAUNTLETREADY2_1
    {HSPR_GAUN, 7, 4, NULL/*A_WeaponReady*/, HS_GAUNTLETREADY2_3},  // HS_GAUNTLETREADY2_2
    {HSPR_GAUN, 8, 4, NULL/*A_WeaponReady*/, HS_GAUNTLETREADY2_1},  // HS_GAUNTLETREADY2_3
    {HSPR_GAUN, 6, 1, NULL/*A_Lower*/, HS_GAUNTLETDOWN2},   // HS_GAUNTLETDOWN2
    {HSPR_GAUN, 6, 1, NULL/*A_Raise*/, HS_GAUNTLETUP2},     // HS_GAUNTLETUP2
    {HSPR_GAUN, 1, 4, NULL, HS_GAUNTLETATK1_2},     // HS_GAUNTLETATK1_1
    {HSPR_GAUN, 2, 4, NULL, HS_GAUNTLETATK1_3},     // HS_GAUNTLETATK1_2
    {HSPR_GAUN, 32771, 4, NULL/*A_GauntletAttack*/, HS_GAUNTLETATK1_4},     // HS_GAUNTLETATK1_3
    {HSPR_GAUN, 32772, 4, NULL/*A_GauntletAttack*/, HS_GAUNTLETATK1_5},     // HS_GAUNTLETATK1_4
    {HSPR_GAUN, 32773, 4, NULL/*A_GauntletAttack*/, HS_GAUNTLETATK1_6},     // HS_GAUNTLETATK1_5
    {HSPR_GAUN, 2, 4, NULL/*A_ReFire*/, HS_GAUNTLETATK1_7}, // HS_GAUNTLETATK1_6
    {HSPR_GAUN, 1, 4, NULL/*A_Light0*/, HS_GAUNTLETREADY},  // HS_GAUNTLETATK1_7
    {HSPR_GAUN, 9, 4, NULL, HS_GAUNTLETATK2_2},     // HS_GAUNTLETATK2_1
    {HSPR_GAUN, 10, 4, NULL, HS_GAUNTLETATK2_3},    // HS_GAUNTLETATK2_2
    {HSPR_GAUN, 32779, 4, NULL/*A_GauntletAttack*/, HS_GAUNTLETATK2_4},     // HS_GAUNTLETATK2_3
    {HSPR_GAUN, 32780, 4, NULL/*A_GauntletAttack*/, HS_GAUNTLETATK2_5},     // HS_GAUNTLETATK2_4
    {HSPR_GAUN, 32781, 4, NULL/*A_GauntletAttack*/, HS_GAUNTLETATK2_6},     // HS_GAUNTLETATK2_5
    {HSPR_GAUN, 10, 4, NULL/*A_ReFire*/, HS_GAUNTLETATK2_7},        // HS_GAUNTLETATK2_6
    {HSPR_GAUN, 9, 4, NULL/*A_Light0*/, HS_GAUNTLETREADY2_1},       // HS_GAUNTLETATK2_7
    {HSPR_PUF1, 32768, 4, NULL, HS_GAUNTLETPUFF1_2},        // HS_GAUNTLETPUFF1_1
    {HSPR_PUF1, 32769, 4, NULL, HS_GAUNTLETPUFF1_3},        // HS_GAUNTLETPUFF1_2
    {HSPR_PUF1, 32770, 4, NULL, HS_GAUNTLETPUFF1_4},        // HS_GAUNTLETPUFF1_3
    {HSPR_PUF1, 32771, 4, NULL, HS_NULL},   // HS_GAUNTLETPUFF1_4
    {HSPR_PUF1, 32772, 4, NULL, HS_GAUNTLETPUFF2_2},        // HS_GAUNTLETPUFF2_1
    {HSPR_PUF1, 32773, 4, NULL, HS_GAUNTLETPUFF2_3},        // HS_GAUNTLETPUFF2_2
    {HSPR_PUF1, 32774, 4, NULL, HS_GAUNTLETPUFF2_4},        // HS_GAUNTLETPUFF2_3
    {HSPR_PUF1, 32775, 4, NULL, HS_NULL},   // HS_GAUNTLETPUFF2_4
    {HSPR_WBLS, 0, -1, NULL, HS_NULL},      // HS_BLSR
    {HSPR_BLSR, 0, 1, NULL/*A_WeaponReady*/, HS_BLASTERREADY},      // HS_BLASTERREADY
    {HSPR_BLSR, 0, 1, NULL/*A_Lower*/, HS_BLASTERDOWN},     // HS_BLASTERDOWN
    {HSPR_BLSR, 0, 1, NULL/*A_Raise*/, HS_BLASTERUP},       // HS_BLASTERUP
    ...
    {HSPR_BLSR, 0, 0, NULL/*A_ReFire*/, HS_BLASTERREADY},   // HS_BLASTERATK1_6
    ...
    {HSPR_BLSR, 0, 0, NULL/*A_ReFire*/, HS_BLASTERREADY},   // HS_BLASTERATK2_6
    {HSPR_ACLO, 4, 200, NULL, HS_BLASTERFX1_1},     // HS_BLASTERFX1_1
    {HSPR_FX18, 32768, 3, NULL/*A_SpawnRippers*/, HS_BLASTERFXI1_2},        // HS_BLASTERFXI1_1
    {HSPR_FX18, 32769, 3, NULL, HS_BLASTERFXI1_3},  // HS_BLASTERFXI1_2
    {HSPR_FX18, 32770, 4, NULL, HS_BLASTERFXI1_4},  // HS_BLASTERFXI1_3
    {HSPR_FX18, 32771, 4, NULL, HS_BLASTERFXI1_5},  // HS_BLASTERFXI1_4
    {HSPR_FX18, 32772, 4, NULL, HS_BLASTERFXI1_6},  // HS_BLASTERFXI1_5
    {HSPR_FX18, 32773, 4, NULL, HS_BLASTERFXI1_7},  // HS_BLASTERFXI1_6
    {HSPR_FX18, 32774, 4, NULL, HS_NULL},   // HS_BLASTERFXI1_7
    ...
    {HSPR_FX18, 32782, 4, NULL, HS_RIPPERX2},       // HS_RIPPERX1
    {HSPR_FX18, 32783, 4, NULL, HS_RIPPERX3},       // HS_RIPPERX2
    {HSPR_FX18, 32784, 4, NULL, HS_RIPPERX4},       // HS_RIPPERX3
    {HSPR_FX18, 32785, 4, NULL, HS_RIPPERX5},       // HS_RIPPERX4
    {HSPR_FX18, 32786, 4, NULL, HS_NULL},   // HS_RIPPERX5
    {HSPR_FX17, 32768, 4, NULL, HS_BLASTERPUFF1_2}, // HS_BLASTERPUFF1_1
    {HSPR_FX17, 32769, 4, NULL, HS_BLASTERPUFF1_3}, // HS_BLASTERPUFF1_2
    {HSPR_FX17, 32770, 4, NULL, HS_BLASTERPUFF1_4}, // HS_BLASTERPUFF1_3
    {HSPR_FX17, 32771, 4, NULL, HS_BLASTERPUFF1_5}, // HS_BLASTERPUFF1_4
    {HSPR_FX17, 32772, 4, NULL, HS_NULL},   // HS_BLASTERPUFF1_5
    {HSPR_FX17, 32773, 3, NULL, HS_BLASTERPUFF2_2}, // HS_BLASTERPUFF2_1
    {HSPR_FX17, 32774, 3, NULL, HS_BLASTERPUFF2_3}, // HS_BLASTERPUFF2_2
    {HSPR_FX17, 32775, 4, NULL, HS_BLASTERPUFF2_4}, // HS_BLASTERPUFF2_3
    {HSPR_FX17, 32776, 4, NULL, HS_BLASTERPUFF2_5}, // HS_BLASTERPUFF2_4
    {HSPR_FX17, 32777, 4, NULL, HS_BLASTERPUFF2_6}, // HS_BLASTERPUFF2_5
    {HSPR_FX17, 32778, 4, NULL, HS_BLASTERPUFF2_7}, // HS_BLASTERPUFF2_6
    {HSPR_FX17, 32779, 4, NULL, HS_NULL},   // HS_BLASTERPUFF2_7
    {HSPR_WMCE, 0, -1, NULL, HS_NULL},      // HS_WMCE
    {HSPR_MACE, 0, 1, NULL/*A_WeaponReady*/, HS_MACEREADY}, // HS_MACEREADY
    {HSPR_MACE, 0, 1, NULL/*A_Lower*/, HS_MACEDOWN},        // HS_MACEDOWN
    {HSPR_MACE, 0, 1, NULL/*A_Raise*/, HS_MACEUP},  // HS_MACEUP
    ...
    {HSPR_MACE, 2, 4, NULL/*A_ReFire*/, HS_MACEATK1_7},     // HS_MACEATK1_6
    ...
    {HSPR_MACE, 0, 8, NULL/*A_ReFire*/, HS_MACEREADY},      // HS_MACEATK2_4
    {HSPR_FX02, 0, 4, NULL/*A_MacePL1Check*/, HS_MACEFX1_2},        // HS_MACEFX1_1
    {HSPR_FX02, 1, 4, NULL/*A_MacePL1Check*/, HS_MACEFX1_1},        // HS_MACEFX1_2
    {HSPR_FX02, 32773, 4, NULL/*A_MaceBallImpact*/, HS_MACEFXI1_2}, // HS_MACEFXI1_1
    {HSPR_FX02, 32774, 4, NULL, HS_MACEFXI1_3},     // HS_MACEFXI1_2
    {HSPR_FX02, 32775, 4, NULL, HS_MACEFXI1_4},     // HS_MACEFXI1_3
    {HSPR_FX02, 32776, 4, NULL, HS_MACEFXI1_5},     // HS_MACEFXI1_4
    {HSPR_FX02, 32777, 4, NULL, HS_NULL},   // HS_MACEFXI1_5
    {HSPR_FX02, 2, 4, NULL, HS_MACEFX2_2},  // HS_MACEFX2_1
    {HSPR_FX02, 3, 4, NULL, HS_MACEFX2_1},  // HS_MACEFX2_2
    {HSPR_FX02, 32773, 4, NULL/*A_MaceBallImpact2*/, HS_MACEFXI1_2},        // HS_MACEFXI2_1
    ...
    {HSPR_FX02, 32770, 4, NULL/*A_DeathBallImpact*/, HS_MACEFXI1_2},        // HS_MACEFXI4_1
    {HSPR_WSKL, 0, -1, NULL, HS_NULL},      // HS_WSKL
    {HSPR_HROD, 0, 1, NULL/*A_WeaponReady*/, HS_HORNRODREADY},      // HS_HORNRODREADY
    {HSPR_HROD, 0, 1, NULL/*A_Lower*/, HS_HORNRODDOWN},     // HS_HORNRODDOWN
    {HSPR_HROD, 0, 1, NULL/*A_Raise*/, HS_HORNRODUP},       // HS_HORNRODUP
    ...
    {HSPR_HROD, 1, 0, NULL/*A_ReFire*/, HS_HORNRODREADY},   // HS_HORNRODATK1_3
    ...
    {HSPR_HROD, 2, 2, NULL/*A_ReFire*/, HS_HORNRODREADY},   // HS_HORNRODATK2_9
    {HSPR_FX00, 32768, 6, NULL, HS_HRODFX1_2},      // HS_HRODFX1_1
    {HSPR_FX00, 32769, 6, NULL, HS_HRODFX1_1},      // HS_HRODFX1_2
    {HSPR_FX00, 32775, 5, NULL, HS_HRODFXI1_2},     // HS_HRODFXI1_1
    {HSPR_FX00, 32776, 5, NULL, HS_HRODFXI1_3},     // HS_HRODFXI1_2
    {HSPR_FX00, 32777, 4, NULL, HS_HRODFXI1_4},     // HS_HRODFXI1_3
    {HSPR_FX00, 32778, 4, NULL, HS_HRODFXI1_5},     // HS_HRODFXI1_4
    {HSPR_FX00, 32779, 3, NULL, HS_HRODFXI1_6},     // HS_HRODFXI1_5
    {HSPR_FX00, 32780, 3, NULL, HS_NULL},   // HS_HRODFXI1_6
    {HSPR_FX00, 32770, 3, NULL, HS_HRODFX2_2},      // HS_HRODFX2_1
    {HSPR_FX00, 32771, 3, NULL/*A_SkullRodPL2Seek*/, HS_HRODFX2_3}, // HS_HRODFX2_2
    {HSPR_FX00, 32772, 3, NULL, HS_HRODFX2_4},      // HS_HRODFX2_3
    {HSPR_FX00, 32773, 3, NULL/*A_SkullRodPL2Seek*/, HS_HRODFX2_1}, // HS_HRODFX2_4
    {HSPR_FX00, 32775, 5, NULL/*A_AddPlayerRain*/, HS_HRODFXI2_2},  // HS_HRODFXI2_1
    {HSPR_FX00, 32776, 5, NULL, HS_HRODFXI2_3},     // HS_HRODFXI2_2
    {HSPR_FX00, 32777, 4, NULL, HS_HRODFXI2_4},     // HS_HRODFXI2_3
    {HSPR_FX00, 32778, 3, NULL, HS_HRODFXI2_5},     // HS_HRODFXI2_4
    {HSPR_FX00, 32779, 3, NULL, HS_HRODFXI2_6},     // HS_HRODFXI2_5
    {HSPR_FX00, 32780, 3, NULL, HS_HRODFXI2_7},     // HS_HRODFXI2_6
    ...
    {HSPR_FX20, 32768, -1, NULL, HS_NULL},  // HS_RAINPLR1_1
    {HSPR_FX21, 32768, -1, NULL, HS_NULL},  // HS_RAINPLR2_1
    {HSPR_FX22, 32768, -1, NULL, HS_NULL},  // HS_RAINPLR3_1
    {HSPR_FX23, 32768, -1, NULL, HS_NULL},  // HS_RAINPLR4_1
    {HSPR_FX20, 32769, 4, NULL/*A_RainImpact*/, HS_RAINPLR1X_2},    // HS_RAINPLR1X_1
    {HSPR_FX20, 32770, 4, NULL, HS_RAINPLR1X_3},    // HS_RAINPLR1X_2
    {HSPR_FX20, 32771, 4, NULL, HS_RAINPLR1X_4},    // HS_RAINPLR1X_3
    {HSPR_FX20, 32772, 4, NULL, HS_RAINPLR1X_5},    // HS_RAINPLR1X_4
    {HSPR_FX20, 32773, 4, NULL, HS_NULL},   // HS_RAINPLR1X_5
    {HSPR_FX21, 32769, 4, NULL/*A_RainImpact*/, HS_RAINPLR2X_2},    // HS_RAINPLR2X_1
    {HSPR_FX21, 32770, 4, NULL, HS_RAINPLR2X_3},    // HS_RAINPLR2X_2
    {HSPR_FX21, 32771, 4, NULL, HS_RAINPLR2X_4},    // HS_RAINPLR2X_3
    {HSPR_FX21, 32772, 4, NULL, HS_RAINPLR2X_5},    // HS_RAINPLR2X_4
    {HSPR_FX21, 32773, 4, NULL, HS_NULL},   // HS_RAINPLR2X_5
    {HSPR_FX22, 32769, 4, NULL/*A_RainImpact*/, HS_RAINPLR3X_2},    // HS_RAINPLR3X_1
    {HSPR_FX22, 32770, 4, NULL, HS_RAINPLR3X_3},    // HS_RAINPLR3X_2
    {HSPR_FX22, 32771, 4, NULL, HS_RAINPLR3X_4},    // HS_RAINPLR3X_3
    {HSPR_FX22, 32772, 4, NULL, HS_RAINPLR3X_5},    // HS_RAINPLR3X_4
    {HSPR_FX22, 32773, 4, NULL, HS_NULL},   // HS_RAINPLR3X_5
    {HSPR_FX23, 32769, 4, NULL/*A_RainImpact*/, HS_RAINPLR4X_2},    // HS_RAINPLR4X_1
    {HSPR_FX23, 32770, 4, NULL, HS_RAINPLR4X_3},    // HS_RAINPLR4X_2
    {HSPR_FX23, 32771, 4, NULL, HS_RAINPLR4X_4},    // HS_RAINPLR4X_3
    {HSPR_FX23, 32772, 4, NULL, HS_RAINPLR4X_5},    // HS_RAINPLR4X_4
    {HSPR_FX23, 32773, 4, NULL, HS_NULL},   // HS_RAINPLR4X_5
    {HSPR_FX20, 32774, 4, NULL, HS_RAINAIRXPLR1_2}, // HS_RAINAIRXPLR1_1
    {HSPR_FX21, 32774, 4, NULL, HS_RAINAIRXPLR2_2}, // HS_RAINAIRXPLR2_1
    {HSPR_FX22, 32774, 4, NULL, HS_RAINAIRXPLR3_2}, // HS_RAINAIRXPLR3_1
    {HSPR_FX23, 32774, 4, NULL, HS_RAINAIRXPLR4_2}, // HS_RAINAIRXPLR4_1
    {HSPR_FX20, 32775, 4, NULL, HS_RAINAIRXPLR1_3}, // HS_RAINAIRXPLR1_2
    {HSPR_FX21, 32775, 4, NULL, HS_RAINAIRXPLR2_3}, // HS_RAINAIRXPLR2_2
    {HSPR_FX22, 32775, 4, NULL, HS_RAINAIRXPLR3_3}, // HS_RAINAIRXPLR3_2
    {HSPR_FX23, 32775, 4, NULL, HS_RAINAIRXPLR4_3}, // HS_RAINAIRXPLR4_2
    {HSPR_FX20, 32776, 4, NULL, HS_NULL},   // HS_RAINAIRXPLR1_3
    {HSPR_FX21, 32776, 4, NULL, HS_NULL},   // HS_RAINAIRXPLR2_3
    {HSPR_FX22, 32776, 4, NULL, HS_NULL},   // HS_RAINAIRXPLR3_3
    {HSPR_FX23, 32776, 4, NULL, HS_NULL},   // HS_RAINAIRXPLR4_3
    {HSPR_GWND, 0, 1, NULL/*A_WeaponReady*/, HS_GOLDWANDREADY},     // HS_GOLDWANDREADY
    {HSPR_GWND, 0, 1, NULL/*A_Lower*/, HS_GOLDWANDDOWN},    // HS_GOLDWANDDOWN
    {HSPR_GWND, 0, 1, NULL/*A_Raise*/, HS_GOLDWANDUP},      // HS_GOLDWANDUP
    ...
    {HSPR_GWND, 3, 0, NULL/*A_ReFire*/, HS_GOLDWANDREADY},  // HS_GOLDWANDATK1_4
    ...
    {HSPR_GWND, 3, 0, NULL/*A_ReFire*/, HS_GOLDWANDREADY},  // HS_GOLDWANDATK2_4
    {HSPR_FX01, 32768, 6, NULL, HS_GWANDFX1_2},     // HS_GWANDFX1_1
    {HSPR_FX01, 32769, 6, NULL, HS_GWANDFX1_1},     // HS_GWANDFX1_2
    {HSPR_FX01, 32772, 3, NULL, HS_GWANDFXI1_2},    // HS_GWANDFXI1_1
    {HSPR_FX01, 32773, 3, NULL, HS_GWANDFXI1_3},    // HS_GWANDFXI1_2
    {HSPR_FX01, 32774, 3, NULL, HS_GWANDFXI1_4},    // HS_GWANDFXI1_3
    {HSPR_FX01, 32775, 3, NULL, HS_NULL},   // HS_GWANDFXI1_4
    {HSPR_FX01, 32770, 6, NULL, HS_GWANDFX2_2},     // HS_GWANDFX2_1
    {HSPR_FX01, 32771, 6, NULL, HS_GWANDFX2_1},     // HS_GWANDFX2_2
    {HSPR_PUF2, 32768, 3, NULL, HS_GWANDPUFF1_2},   // HS_GWANDPUFF1_1
    {HSPR_PUF2, 32769, 3, NULL, HS_GWANDPUFF1_3},   // HS_GWANDPUFF1_2
    {HSPR_PUF2, 32770, 3, NULL, HS_GWANDPUFF1_4},   // HS_GWANDPUFF1_3
    {HSPR_PUF2, 32771, 3, NULL, HS_GWANDPUFF1_5},   // HS_GWANDPUFF1_4
    {HSPR_PUF2, 32772, 3, NULL, HS_NULL},   // HS_GWANDPUFF1_5
    {HSPR_WPHX, 0, -1, NULL, HS_NULL},      // HS_WPHX
    {HSPR_PHNX, 0, 1, NULL/*A_WeaponReady*/, HS_PHOENIXREADY},      // HS_PHOENIXREADY
    {HSPR_PHNX, 0, 1, NULL/*A_Lower*/, HS_PHOENIXDOWN},     // HS_PHOENIXDOWN
    {HSPR_PHNX, 0, 1, NULL/*A_Raise*/, HS_PHOENIXUP},       // HS_PHOENIXUP
    ...
    {HSPR_PHNX, 1, 0, NULL/*A_ReFire*/, HS_PHOENIXREADY},   // HS_PHOENIXATK1_5
    {HSPR_PHNX, 1, 3, NULL/*A_InitPhoenixPL2*/, HS_PHOENIXATK2_2},  // HS_PHOENIXATK2_1
    {HSPR_PHNX, 32770, 1, NULL/*A_FirePhoenixPL2*/, HS_PHOENIXATK2_3},      // HS_PHOENIXATK2_2
    {HSPR_PHNX, 1, 4, NULL/*A_ReFire*/, HS_PHOENIXATK2_4},  // HS_PHOENIXATK2_3
    {HSPR_PHNX, 1, 4, NULL/*A_ShutdownPhoenixPL2*/, HS_PHOENIXREADY},       // HS_PHOENIXATK2_4
    {HSPR_FX04, 32768, 4, NULL/*A_PhoenixPuff*/, HS_PHOENIXFX1_1},  // HS_PHOENIXFX1_1
    {HSPR_FX08, 32768, 6, NULL/*A_Explode*/, HS_PHOENIXFXI1_2},     // HS_PHOENIXFXI1_1
    {HSPR_FX08, 32769, 5, NULL, HS_PHOENIXFXI1_3},  // HS_PHOENIXFXI1_2
    {HSPR_FX08, 32770, 5, NULL, HS_PHOENIXFXI1_4},  // HS_PHOENIXFXI1_3
    {HSPR_FX08, 32771, 4, NULL, HS_PHOENIXFXI1_5},  // HS_PHOENIXFXI1_4
    {HSPR_FX08, 32772, 4, NULL, HS_PHOENIXFXI1_6},  // HS_PHOENIXFXI1_5
    {HSPR_FX08, 32773, 4, NULL, HS_PHOENIXFXI1_7},  // HS_PHOENIXFXI1_6
    {HSPR_FX08, 32774, 4, NULL, HS_PHOENIXFXI1_8},  // HS_PHOENIXFXI1_7
    {HSPR_FX08, 32775, 4, NULL, HS_NULL},   // HS_PHOENIXFXI1_8
    {HSPR_FX08, 32776, 8, NULL, HS_PHOENIXFXIX_1, 0, 0 }, // HS_PHOENIXFXIX_1
    {HSPR_FX08, 32777, 8, NULL/*A_RemovedPhoenixFunc*/, HS_PHOENIXFXIX_2, 0, 0 },  // HS_PHOENIXFXIX_2
    {HSPR_FX08, 32778, 8, NULL, HS_NULL, 0, 0 },          // HS_PHOENIXFXIX_3
    ...
    {HSPR_FX09, 32768, 2, NULL, HS_PHOENIXFX2_2},   // HS_PHOENIXFX2_1
    {HSPR_FX09, 32769, 2, NULL, HS_PHOENIXFX2_3},   // HS_PHOENIXFX2_2
    {HSPR_FX09, 32768, 2, NULL, HS_PHOENIXFX2_4},   // HS_PHOENIXFX2_3
    {HSPR_FX09, 32769, 2, NULL, HS_PHOENIXFX2_5},   // HS_PHOENIXFX2_4
    {HSPR_FX09, 32768, 2, NULL, HS_PHOENIXFX2_6},   // HS_PHOENIXFX2_5
    {HSPR_FX09, 32769, 2, NULL/*A_FlameEnd*/, HS_PHOENIXFX2_7},     // HS_PHOENIXFX2_6
    {HSPR_FX09, 32770, 2, NULL, HS_PHOENIXFX2_8},   // HS_PHOENIXFX2_7
    {HSPR_FX09, 32771, 2, NULL, HS_PHOENIXFX2_9},   // HS_PHOENIXFX2_8
    {HSPR_FX09, 32772, 2, NULL, HS_PHOENIXFX2_10},  // HS_PHOENIXFX2_9
    {HSPR_FX09, 32773, 2, NULL, HS_NULL},   // HS_PHOENIXFX2_10
    {HSPR_FX09, 32774, 3, NULL, HS_PHOENIXFXI2_2},  // HS_PHOENIXFXI2_1
    {HSPR_FX09, 32775, 3, NULL/*A_FloatPuff*/, HS_PHOENIXFXI2_3},   // HS_PHOENIXFXI2_2
    {HSPR_FX09, 32776, 4, NULL, HS_PHOENIXFXI2_4},  // HS_PHOENIXFXI2_3
    {HSPR_FX09, 32777, 5, NULL, HS_PHOENIXFXI2_5},  // HS_PHOENIXFXI2_4
    {HSPR_FX09, 32778, 5, NULL, HS_NULL},   // HS_PHOENIXFXI2_5
    {HSPR_WBOW, 0, -1, NULL, HS_NULL},      // HS_WBOW
    {HSPR_CRBW, 0, 1, NULL/*A_WeaponReady*/, HS_CRBOW2},    // HS_CRBOW1
    {HSPR_CRBW, 0, 1, NULL/*A_WeaponReady*/, HS_CRBOW3},    // HS_CRBOW2
    {HSPR_CRBW, 0, 1, NULL/*A_WeaponReady*/, HS_CRBOW4},    // HS_CRBOW3
    {HSPR_CRBW, 0, 1, NULL/*A_WeaponReady*/, HS_CRBOW5},    // HS_CRBOW4
    {HSPR_CRBW, 0, 1, NULL/*A_WeaponReady*/, HS_CRBOW6},    // HS_CRBOW5
    {HSPR_CRBW, 0, 1, NULL/*A_WeaponReady*/, HS_CRBOW7},    // HS_CRBOW6
    {HSPR_CRBW, 1, 1, NULL/*A_WeaponReady*/, HS_CRBOW8},    // HS_CRBOW7
    {HSPR_CRBW, 1, 1, NULL/*A_WeaponReady*/, HS_CRBOW9},    // HS_CRBOW8
    {HSPR_CRBW, 1, 1, NULL/*A_WeaponReady*/, HS_CRBOW10},   // HS_CRBOW9
    {HSPR_CRBW, 1, 1, NULL/*A_WeaponReady*/, HS_CRBOW11},   // HS_CRBOW10
    {HSPR_CRBW, 1, 1, NULL/*A_WeaponReady*/, HS_CRBOW12},   // HS_CRBOW11
    {HSPR_CRBW, 1, 1, NULL/*A_WeaponReady*/, HS_CRBOW13},   // HS_CRBOW12
    {HSPR_CRBW, 2, 1, NULL/*A_WeaponReady*/, HS_CRBOW14},   // HS_CRBOW13
    {HSPR_CRBW, 2, 1, NULL/*A_WeaponReady*/, HS_CRBOW15},   // HS_CRBOW14
    {HSPR_CRBW, 2, 1, NULL/*A_WeaponReady*/, HS_CRBOW16},   // HS_CRBOW15
    {HSPR_CRBW, 2, 1, NULL/*A_WeaponReady*/, HS_CRBOW17},   // HS_CRBOW16
    {HSPR_CRBW, 2, 1, NULL/*A_WeaponReady*/, HS_CRBOW18},   // HS_CRBOW17
    {HSPR_CRBW, 2, 1, NULL/*A_WeaponReady*/, HS_CRBOW1},    // HS_CRBOW18
    {HSPR_CRBW, 0, 1, NULL/*A_Lower*/, HS_CRBOWDOWN},       // HS_CRBOWDOWN
    {HSPR_CRBW, 0, 1, NULL/*A_Raise*/, HS_CRBOWUP}, // HS_CRBOWUP
    ...
    {HSPR_CRBW, 2, 5, NULL/*A_ReFire*/, HS_CRBOW1}, // HS_CRBOWATK1_8
    ...
    {HSPR_CRBW, 2, 4, NULL/*A_ReFire*/, HS_CRBOW1}, // HS_CRBOWATK2_8
    {HSPR_FX03, 32769, 1, NULL, HS_CRBOWFX1},       // HS_CRBOWFX1
    {HSPR_FX03, 32775, 8, NULL, HS_CRBOWFXI1_2},    // HS_CRBOWFXI1_1
    {HSPR_FX03, 32776, 8, NULL, HS_CRBOWFXI1_3},    // HS_CRBOWFXI1_2
    {HSPR_FX03, 32777, 8, NULL, HS_NULL},   // HS_CRBOWFXI1_3
    {HSPR_FX03, 32769, 1, NULL/*A_BoltSpark*/, HS_CRBOWFX2},        // HS_CRBOWFX2
    {HSPR_FX03, 32768, 1, NULL, HS_CRBOWFX3},       // HS_CRBOWFX3
    {HSPR_FX03, 32770, 8, NULL, HS_CRBOWFXI3_2},    // HS_CRBOWFXI3_1
    {HSPR_FX03, 32771, 8, NULL, HS_CRBOWFXI3_3},    // HS_CRBOWFXI3_2
    {HSPR_FX03, 32772, 8, NULL, HS_NULL},   // HS_CRBOWFXI3_3
    {HSPR_FX03, 32773, 8, NULL, HS_CRBOWFX4_2},     // HS_CRBOWFX4_1
    {HSPR_FX03, 32774, 8, NULL, HS_NULL},   // HS_CRBOWFX4_2
    ...
    {HSPR_PLAY, 32773, 6, NULL, HS_PLAY_ATK1},      // HS_PLAY_ATK2
    {HSPR_PLAY, 6, 4, NULL, HS_PLAY_PAIN2}, // HS_PLAY_PAIN
    {HSPR_PLAY, 6, 4, NULL/*A_Pain*/, HS_PLAY},     // HS_PLAY_PAIN2
    {HSPR_PLAY, 7, 6, NULL, HS_PLAY_DIE2},  // HS_PLAY_DIE1
    {HSPR_PLAY, 8, 6, NULL/*A_Scream*/, HS_PLAY_DIE3},      // HS_PLAY_DIE2
    ...
    {HSPR_PLAY, 16, 5, NULL/*A_Scream*/, HS_PLAY_XDIE2},    // HS_PLAY_XDIE1
    {HSPR_PLAY, 17, 5, NULL/*A_SkullPop*/, HS_PLAY_XDIE3},  // HS_PLAY_XDIE2
    ...
    {HSPR_FDTH, 32768, 5, NULL/*A_FlameSnd*/, HS_PLAY_FDTH2},       // HS_PLAY_FDTH1
    {HSPR_FDTH, 32769, 4, NULL, HS_PLAY_FDTH3},     // HS_PLAY_FDTH2
    {HSPR_FDTH, 32770, 5, NULL, HS_PLAY_FDTH4},     // HS_PLAY_FDTH3
    {HSPR_FDTH, 32771, 4, NULL/*A_Scream*/, HS_PLAY_FDTH5}, // HS_PLAY_FDTH4
    {HSPR_FDTH, 32772, 5, NULL, HS_PLAY_FDTH6},     // HS_PLAY_FDTH5
    {HSPR_FDTH, 32773, 4, NULL, HS_PLAY_FDTH7},     // HS_PLAY_FDTH6
    {HSPR_FDTH, 32774, 5, NULL/*A_FlameSnd*/, HS_PLAY_FDTH8},       // HS_PLAY_FDTH7
    {HSPR_FDTH, 32775, 4, NULL, HS_PLAY_FDTH9},     // HS_PLAY_FDTH8
    {HSPR_FDTH, 32776, 5, NULL, HS_PLAY_FDTH10},    // HS_PLAY_FDTH9
    {HSPR_FDTH, 32777, 4, NULL, HS_PLAY_FDTH11},    // HS_PLAY_FDTH10
    {HSPR_FDTH, 32778, 5, NULL, HS_PLAY_FDTH12},    // HS_PLAY_FDTH11
    {HSPR_FDTH, 32779, 4, NULL, HS_PLAY_FDTH13},    // HS_PLAY_FDTH12
    {HSPR_FDTH, 32780, 5, NULL, HS_PLAY_FDTH14},    // HS_PLAY_FDTH13
    {HSPR_FDTH, 32781, 4, NULL, HS_PLAY_FDTH15},    // HS_PLAY_FDTH14
    {HSPR_FDTH, 32782, 5, NULL/*A_NoBlocking*/, HS_PLAY_FDTH16},    // HS_PLAY_FDTH15
    {HSPR_FDTH, 32783, 4, NULL, HS_PLAY_FDTH17},    // HS_PLAY_FDTH16
    {HSPR_FDTH, 32784, 5, NULL, HS_PLAY_FDTH18},    // HS_PLAY_FDTH17
    {HSPR_FDTH, 32785, 4, NULL, HS_PLAY_FDTH19},    // HS_PLAY_FDTH18
    ...
    {HSPR_CHKN, 2, 4, NULL/*A_Pain*/, HS_CHICPLAY}, // HS_CHICPLAY_PAIN2
    ...
    {HSPR_CHKN, 0, 8, NULL/*A_FaceTarget*/, HS_CHICKEN_ATK2},       // HS_CHICKEN_ATK1
    {HSPR_CHKN, 2, 10, NULL/*A_ChicAttack*/, HS_CHICKEN_WALK1},     // HS_CHICKEN_ATK2
    {HSPR_CHKN, 4, 6, NULL/*A_Scream*/, HS_CHICKEN_DIE2},   // HS_CHICKEN_DIE1
    ...
    {HSPR_MUMM, 0, 10, NULL/*A_Look*/, HS_MUMMY_LOOK2},     // HS_MUMMY_LOOK1
    {HSPR_MUMM, 1, 10, NULL/*A_Look*/, HS_MUMMY_LOOK1},     // HS_MUMMY_LOOK2
    {HSPR_MUMM, 0, 4, NULL/*A_Chase*/, HS_MUMMY_WALK2},     // HS_MUMMY_WALK1
    {HSPR_MUMM, 1, 4, NULL/*A_Chase*/, HS_MUMMY_WALK3},     // HS_MUMMY_WALK2
    {HSPR_MUMM, 2, 4, NULL/*A_Chase*/, HS_MUMMY_WALK4},     // HS_MUMMY_WALK3
    {HSPR_MUMM, 3, 4, NULL/*A_Chase*/, HS_MUMMY_WALK1},     // HS_MUMMY_WALK4
    {HSPR_MUMM, 4, 6, NULL/*A_FaceTarget*/, HS_MUMMY_ATK2}, // HS_MUMMY_ATK1
    {HSPR_MUMM, 5, 6, NULL/*A_MummyAttack*/, HS_MUMMY_ATK3},        // HS_MUMMY_ATK2
    {HSPR_MUMM, 6, 6, NULL/*A_FaceTarget*/, HS_MUMMY_WALK1},        // HS_MUMMY_ATK3
    {HSPR_MUMM, 23, 5, NULL/*A_FaceTarget*/, HS_MUMMYL_ATK2},       // HS_MUMMYL_ATK1
    {HSPR_MUMM, 32792, 5, NULL/*A_FaceTarget*/, HS_MUMMYL_ATK3},    // HS_MUMMYL_ATK2
    {HSPR_MUMM, 23, 5, NULL/*A_FaceTarget*/, HS_MUMMYL_ATK4},       // HS_MUMMYL_ATK3
    {HSPR_MUMM, 32792, 5, NULL/*A_FaceTarget*/, HS_MUMMYL_ATK5},    // HS_MUMMYL_ATK4
    {HSPR_MUMM, 23, 5, NULL/*A_FaceTarget*/, HS_MUMMYL_ATK6},       // HS_MUMMYL_ATK5
    {HSPR_MUMM, 32792, 15, NULL/*A_MummyAttack2*/, HS_MUMMY_WALK1}, // HS_MUMMYL_ATK6
    {HSPR_MUMM, 7, 4, NULL, HS_MUMMY_PAIN2},        // HS_MUMMY_PAIN1
    {HSPR_MUMM, 7, 4, NULL/*A_Pain*/, HS_MUMMY_WALK1},      // HS_MUMMY_PAIN2
    {HSPR_MUMM, 8, 5, NULL, HS_MUMMY_DIE2}, // HS_MUMMY_DIE1
    {HSPR_MUMM, 9, 5, NULL/*A_Scream*/, HS_MUMMY_DIE3},     // HS_MUMMY_DIE2
    ...
    {HSPR_FX15, 32768, 5, NULL/*A_ContMobjSound*/, HS_MUMMYFX1_2},  // HS_MUMMYFX1_1
    {HSPR_FX15, 32769, 5, NULL/*A_MummyFX1Seek*/, HS_MUMMYFX1_3},   // HS_MUMMYFX1_2
    {HSPR_FX15, 32770, 5, NULL, HS_MUMMYFX1_4},     // HS_MUMMYFX1_3
    {HSPR_FX15, 32769, 5, NULL/*A_MummyFX1Seek*/, HS_MUMMYFX1_1},   // HS_MUMMYFX1_4
    {HSPR_FX15, 32771, 5, NULL, HS_MUMMYFXI1_2},    // HS_MUMMYFXI1_1
    {HSPR_FX15, 32772, 5, NULL, HS_MUMMYFXI1_3},    // HS_MUMMYFXI1_2
    {HSPR_FX15, 32773, 5, NULL, HS_MUMMYFXI1_4},    // HS_MUMMYFXI1_3
    {HSPR_FX15, 32774, 5, NULL, HS_NULL},   // HS_MUMMYFXI1_4
    {HSPR_BEAS, 0, 10, NULL/*A_Look*/, HS_BEAST_LOOK2},     // HS_BEAST_LOOK1
    {HSPR_BEAS, 1, 10, NULL/*A_Look*/, HS_BEAST_LOOK1},     // HS_BEAST_LOOK2
    {HSPR_BEAS, 0, 3, NULL/*A_Chase*/, HS_BEAST_WALK2},     // HS_BEAST_WALK1
    {HSPR_BEAS, 1, 3, NULL/*A_Chase*/, HS_BEAST_WALK3},     // HS_BEAST_WALK2
    {HSPR_BEAS, 2, 3, NULL/*A_Chase*/, HS_BEAST_WALK4},     // HS_BEAST_WALK3
    {HSPR_BEAS, 3, 3, NULL/*A_Chase*/, HS_BEAST_WALK5},     // HS_BEAST_WALK4
    {HSPR_BEAS, 4, 3, NULL/*A_Chase*/, HS_BEAST_WALK6},     // HS_BEAST_WALK5
    {HSPR_BEAS, 5, 3, NULL/*A_Chase*/, HS_BEAST_WALK1},     // HS_BEAST_WALK6
    {HSPR_BEAS, 7, 10, NULL/*A_FaceTarget*/, HS_BEAST_ATK2},        // HS_BEAST_ATK1
    {HSPR_BEAS, 8, 10, NULL/*A_BeastAttack*/, HS_BEAST_WALK1},      // HS_BEAST_ATK2
    {HSPR_BEAS, 6, 3, NULL, HS_BEAST_PAIN2},        // HS_BEAST_PAIN1
    {HSPR_BEAS, 6, 3, NULL/*A_Pain*/, HS_BEAST_WALK1},      // HS_BEAST_PAIN2
    {HSPR_BEAS, 17, 6, NULL, HS_BEAST_DIE2},        // HS_BEAST_DIE1
    {HSPR_BEAS, 18, 6, NULL/*A_Scream*/, HS_BEAST_DIE3},    // HS_BEAST_DIE2
    ...
    {HSPR_BEAS, 10, 6, NULL/*A_Scream*/, HS_BEAST_XDIE3},   // HS_BEAST_XDIE2
    ...
    {HSPR_FRB1, 32768, 4, NULL, HS_BURNBALLFB2},    // HS_BURNBALLFB1
    {HSPR_FRB1, 32769, 4, NULL, HS_BURNBALLFB3},    // HS_BURNBALLFB2
    {HSPR_FRB1, 32770, 4, NULL, HS_BURNBALLFB4},    // HS_BURNBALLFB3
    {HSPR_FRB1, 32771, 4, NULL, HS_BURNBALLFB5},    // HS_BURNBALLFB4
    {HSPR_FRB1, 32772, 4, NULL, HS_BURNBALLFB6},    // HS_BURNBALLFB5
    {HSPR_FRB1, 32773, 4, NULL, HS_BURNBALLFB7},    // HS_BURNBALLFB6
    {HSPR_FRB1, 32774, 4, NULL, HS_BURNBALLFB8},    // HS_BURNBALLFB7
    {HSPR_FRB1, 32775, 4, NULL, HS_NULL},   // HS_BURNBALLFB8
    ...
    {HSPR_SNKE, 0, 10, NULL/*A_Look*/, HS_SNAKE_LOOK2},     // HS_SNAKE_LOOK1
    {HSPR_SNKE, 1, 10, NULL/*A_Look*/, HS_SNAKE_LOOK1},     // HS_SNAKE_LOOK2
    {HSPR_SNKE, 0, 4, NULL/*A_Chase*/, HS_SNAKE_WALK2},     // HS_SNAKE_WALK1
    {HSPR_SNKE, 1, 4, NULL/*A_Chase*/, HS_SNAKE_WALK3},     // HS_SNAKE_WALK2
    {HSPR_SNKE, 2, 4, NULL/*A_Chase*/, HS_SNAKE_WALK4},     // HS_SNAKE_WALK3
    {HSPR_SNKE, 3, 4, NULL/*A_Chase*/, HS_SNAKE_WALK1},     // HS_SNAKE_WALK4
    {HSPR_SNKE, 5, 5, NULL/*A_FaceTarget*/, HS_SNAKE_ATK2}, // HS_SNAKE_ATK1
    {HSPR_SNKE, 5, 5, NULL/*A_FaceTarget*/, HS_SNAKE_ATK3}, // HS_SNAKE_ATK2
    ...
    {HSPR_SNKE, 5, 5, NULL/*A_FaceTarget*/, HS_SNAKE_ATK7}, // HS_SNAKE_ATK6
    {HSPR_SNKE, 5, 5, NULL/*A_FaceTarget*/, HS_SNAKE_ATK8}, // HS_SNAKE_ATK7
    {HSPR_SNKE, 5, 5, NULL/*A_FaceTarget*/, HS_SNAKE_ATK9}, // HS_SNAKE_ATK8
    {HSPR_SNKE, 5, 4, NULL/*A_SnakeAttack2*/, HS_SNAKE_WALK1},      // HS_SNAKE_ATK9
    {HSPR_SNKE, 4, 3, NULL, HS_SNAKE_PAIN2},        // HS_SNAKE_PAIN1
    {HSPR_SNKE, 4, 3, NULL/*A_Pain*/, HS_SNAKE_WALK1},      // HS_SNAKE_PAIN2
    {HSPR_SNKE, 6, 5, NULL, HS_SNAKE_DIE2}, // HS_SNAKE_DIE1
    {HSPR_SNKE, 7, 5, NULL/*A_Scream*/, HS_SNAKE_DIE3},     // HS_SNAKE_DIE2
    ...
    {HSPR_SNFX, 32768, 5, NULL, HS_SNAKEPRO_A2},    // HS_SNAKEPRO_A1
    {HSPR_SNFX, 32769, 5, NULL, HS_SNAKEPRO_A3},    // HS_SNAKEPRO_A2
    {HSPR_SNFX, 32770, 5, NULL, HS_SNAKEPRO_A4},    // HS_SNAKEPRO_A3
    {HSPR_SNFX, 32771, 5, NULL, HS_SNAKEPRO_A1},    // HS_SNAKEPRO_A4
    {HSPR_SNFX, 32772, 5, NULL, HS_SNAKEPRO_AX2},   // HS_SNAKEPRO_AX1
    {HSPR_SNFX, 32773, 5, NULL, HS_SNAKEPRO_AX3},   // HS_SNAKEPRO_AX2
    {HSPR_SNFX, 32774, 4, NULL, HS_SNAKEPRO_AX4},   // HS_SNAKEPRO_AX3
    {HSPR_SNFX, 32775, 3, NULL, HS_SNAKEPRO_AX5},   // HS_SNAKEPRO_AX4
    {HSPR_SNFX, 32776, 3, NULL, HS_NULL},   // HS_SNAKEPRO_AX5
    {HSPR_SNFX, 32777, 6, NULL, HS_SNAKEPRO_B2},    // HS_SNAKEPRO_B1
    {HSPR_SNFX, 32778, 6, NULL, HS_SNAKEPRO_B1},    // HS_SNAKEPRO_B2
    {HSPR_SNFX, 32779, 5, NULL, HS_SNAKEPRO_BX2},   // HS_SNAKEPRO_BX1
    {HSPR_SNFX, 32780, 5, NULL, HS_SNAKEPRO_BX3},   // HS_SNAKEPRO_BX2
    {HSPR_SNFX, 32781, 4, NULL, HS_SNAKEPRO_BX4},   // HS_SNAKEPRO_BX3
    {HSPR_SNFX, 32782, 3, NULL, HS_NULL},   // HS_SNAKEPRO_BX4
    {HSPR_HEAD, 0, 10, NULL/*A_Look*/, HS_HEAD_LOOK},       // HS_HEAD_LOOK
    {HSPR_HEAD, 0, 4, NULL/*A_Chase*/, HS_HEAD_FLOAT},      // HS_HEAD_FLOAT
    {HSPR_HEAD, 0, 5, NULL/*A_FaceTarget*/, HS_HEAD_ATK2},  // HS_HEAD_ATK1
    {HSPR_HEAD, 1, 20, NULL/*A_HeadAttack*/, HS_HEAD_FLOAT},        // HS_HEAD_ATK2
    {HSPR_HEAD, 0, 4, NULL, HS_HEAD_PAIN2}, // HS_HEAD_PAIN1
    {HSPR_HEAD, 0, 4, NULL/*A_Pain*/, HS_HEAD_FLOAT},       // HS_HEAD_PAIN2
    {HSPR_HEAD, 2, 7, NULL, HS_HEAD_DIE2},  // HS_HEAD_DIE1
    {HSPR_HEAD, 3, 7, NULL/*A_Scream*/, HS_HEAD_DIE3},      // HS_HEAD_DIE2
    ...
    {HSPR_CLNK, 0, 10, NULL/*A_Look*/, HS_CLINK_LOOK2},     // HS_CLINK_LOOK1
    {HSPR_CLNK, 1, 10, NULL/*A_Look*/, HS_CLINK_LOOK1},     // HS_CLINK_LOOK2
    {HSPR_CLNK, 0, 3, NULL/*A_Chase*/, HS_CLINK_WALK2},     // HS_CLINK_WALK1
    {HSPR_CLNK, 1, 3, NULL/*A_Chase*/, HS_CLINK_WALK3},     // HS_CLINK_WALK2
    {HSPR_CLNK, 2, 3, NULL/*A_Chase*/, HS_CLINK_WALK4},     // HS_CLINK_WALK3
    {HSPR_CLNK, 3, 3, NULL/*A_Chase*/, HS_CLINK_WALK1},     // HS_CLINK_WALK4
    {HSPR_CLNK, 4, 5, NULL/*A_FaceTarget*/, HS_CLINK_ATK2}, // HS_CLINK_ATK1
    {HSPR_CLNK, 5, 4, NULL/*A_FaceTarget*/, HS_CLINK_ATK3}, // HS_CLINK_ATK2
    {HSPR_CLNK, 6, 7, NULL/*A_ClinkAttack*/, HS_CLINK_WALK1},       // HS_CLINK_ATK3
    {HSPR_CLNK, 7, 3, NULL, HS_CLINK_PAIN2},        // HS_CLINK_PAIN1
    {HSPR_CLNK, 7, 3, NULL/*A_Pain*/, HS_CLINK_WALK1},      // HS_CLINK_PAIN2
    {HSPR_CLNK, 8, 6, NULL, HS_CLINK_DIE2}, // HS_CLINK_DIE1
    {HSPR_CLNK, 9, 6, NULL, HS_CLINK_DIE3}, // HS_CLINK_DIE2
    {HSPR_CLNK, 10, 5, NULL/*A_Scream*/, HS_CLINK_DIE4},    // HS_CLINK_DIE3
    ...
    {HSPR_WZRD, 0, 10, NULL/*A_Look*/, HS_WIZARD_LOOK2},    // HS_WIZARD_LOOK1
    {HSPR_WZRD, 1, 10, NULL/*A_Look*/, HS_WIZARD_LOOK1},    // HS_WIZARD_LOOK2
    {HSPR_WZRD, 0, 3, NULL/*A_Chase*/, HS_WIZARD_WALK2},    // HS_WIZARD_WALK1
    {HSPR_WZRD, 0, 4, NULL/*A_Chase*/, HS_WIZARD_WALK3},    // HS_WIZARD_WALK2
    {HSPR_WZRD, 0, 3, NULL/*A_Chase*/, HS_WIZARD_WALK4},    // HS_WIZARD_WALK3
    {HSPR_WZRD, 0, 4, NULL/*A_Chase*/, HS_WIZARD_WALK5},    // HS_WIZARD_WALK4
    {HSPR_WZRD, 1, 3, NULL/*A_Chase*/, HS_WIZARD_WALK6},    // HS_WIZARD_WALK5
    {HSPR_WZRD, 1, 4, NULL/*A_Chase*/, HS_WIZARD_WALK7},    // HS_WIZARD_WALK6
    {HSPR_WZRD, 1, 3, NULL/*A_Chase*/, HS_WIZARD_WALK8},    // HS_WIZARD_WALK7
    {HSPR_WZRD, 1, 4, NULL/*A_Chase*/, HS_WIZARD_WALK1},    // HS_WIZARD_WALK8
    ...
    {HSPR_WZRD, 4, 3, NULL/*A_Pain*/, HS_WIZARD_WALK1},     // HS_WIZARD_PAIN2
    {HSPR_WZRD, 5, 6, NULL/*A_GhostOff*/, HS_WIZARD_DIE2},  // HS_WIZARD_DIE1
    {HSPR_WZRD, 6, 6, NULL/*A_Scream*/, HS_WIZARD_DIE3},    // HS_WIZARD_DIE2
    ...
    {HSPR_FX11, 32768, 6, NULL, HS_WIZFX1_2},       // HS_WIZFX1_1
    {HSPR_FX11, 32769, 6, NULL, HS_WIZFX1_1},       // HS_WIZFX1_2
    {HSPR_FX11, 32770, 5, NULL, HS_WIZFXI1_2},      // HS_WIZFXI1_1
    {HSPR_FX11, 32771, 5, NULL, HS_WIZFXI1_3},      // HS_WIZFXI1_2
    {HSPR_FX11, 32772, 5, NULL, HS_WIZFXI1_4},      // HS_WIZFXI1_3
    {HSPR_FX11, 32773, 5, NULL, HS_WIZFXI1_5},      // HS_WIZFXI1_4
    {HSPR_FX11, 32774, 5, NULL, HS_NULL},   // HS_WIZFXI1_5
    {HSPR_IMPX, 0, 10, NULL/*A_Look*/, HS_IMP_LOOK2},       // HS_IMP_LOOK1
    {HSPR_IMPX, 1, 10, NULL/*A_Look*/, HS_IMP_LOOK3},       // HS_IMP_LOOK2
    {HSPR_IMPX, 2, 10, NULL/*A_Look*/, HS_IMP_LOOK4},       // HS_IMP_LOOK3
    {HSPR_IMPX, 1, 10, NULL/*A_Look*/, HS_IMP_LOOK1},       // HS_IMP_LOOK4
    {HSPR_IMPX, 0, 3, NULL/*A_Chase*/, HS_IMP_FLY2},        // HS_IMP_FLY1
    {HSPR_IMPX, 0, 3, NULL/*A_Chase*/, HS_IMP_FLY3},        // HS_IMP_FLY2
    {HSPR_IMPX, 1, 3, NULL/*A_Chase*/, HS_IMP_FLY4},        // HS_IMP_FLY3
    {HSPR_IMPX, 1, 3, NULL/*A_Chase*/, HS_IMP_FLY5},        // HS_IMP_FLY4
    {HSPR_IMPX, 2, 3, NULL/*A_Chase*/, HS_IMP_FLY6},        // HS_IMP_FLY5
    {HSPR_IMPX, 2, 3, NULL/*A_Chase*/, HS_IMP_FLY7},        // HS_IMP_FLY6
    {HSPR_IMPX, 1, 3, NULL/*A_Chase*/, HS_IMP_FLY8},        // HS_IMP_FLY7
    {HSPR_IMPX, 1, 3, NULL/*A_Chase*/, HS_IMP_FLY1},        // HS_IMP_FLY8
    {HSPR_IMPX, 3, 6, NULL/*A_FaceTarget*/, HS_IMP_MEATK2}, // HS_IMP_MEATK1
    {HSPR_IMPX, 4, 6, NULL/*A_FaceTarget*/, HS_IMP_MEATK3}, // HS_IMP_MEATK2
    {HSPR_IMPX, 5, 6, NULL/*A_ImpMeAttack*/, HS_IMP_FLY1},  // HS_IMP_MEATK3
    {HSPR_IMPX, 0, 10, NULL/*A_FaceTarget*/, HS_IMP_MSATK1_2},      // HS_IMP_MSATK1_1
    ...
    {HSPR_IMPX, 3, 6, NULL/*A_FaceTarget*/, HS_IMP_MSATK2_2},       // HS_IMP_MSATK2_1
    {HSPR_IMPX, 4, 6, NULL/*A_FaceTarget*/, HS_IMP_MSATK2_3},       // HS_IMP_MSATK2_2
    {HSPR_IMPX, 5, 6, NULL/*A_ImpMsAttack2*/, HS_IMP_FLY1}, // HS_IMP_MSATK2_3
    {HSPR_IMPX, 6, 3, NULL, HS_IMP_PAIN2},  // HS_IMP_PAIN1
    {HSPR_IMPX, 6, 3, NULL/*A_Pain*/, HS_IMP_FLY1}, // HS_IMP_PAIN2
    ...
    {HSPR_IMPX, 9, 7, NULL/*A_Scream*/, HS_IMP_CRASH3},     // HS_IMP_CRASH2
    ...
    {HSPR_FX10, 32768, 6, NULL, HS_IMPFX2}, // HS_IMPFX1
    {HSPR_FX10, 32769, 6, NULL, HS_IMPFX3}, // HS_IMPFX2
    {HSPR_FX10, 32770, 6, NULL, HS_IMPFX1}, // HS_IMPFX3
    {HSPR_FX10, 32771, 5, NULL, HS_IMPFXI2},        // HS_IMPFXI1
    {HSPR_FX10, 32772, 5, NULL, HS_IMPFXI3},        // HS_IMPFXI2
    {HSPR_FX10, 32773, 5, NULL, HS_IMPFXI4},        // HS_IMPFXI3
    {HSPR_FX10, 32774, 5, NULL, HS_NULL},   // HS_IMPFXI4
    {HSPR_KNIG, 0, 10, NULL/*A_Look*/, HS_KNIGHT_STND2},    // HS_KNIGHT_STND1
    {HSPR_KNIG, 1, 10, NULL/*A_Look*/, HS_KNIGHT_STND1},    // HS_KNIGHT_STND2
    {HSPR_KNIG, 0, 4, NULL/*A_Chase*/, HS_KNIGHT_WALK2},    // HS_KNIGHT_WALK1
    {HSPR_KNIG, 1, 4, NULL/*A_Chase*/, HS_KNIGHT_WALK3},    // HS_KNIGHT_WALK2
    {HSPR_KNIG, 2, 4, NULL/*A_Chase*/, HS_KNIGHT_WALK4},    // HS_KNIGHT_WALK3
    {HSPR_KNIG, 3, 4, NULL/*A_Chase*/, HS_KNIGHT_WALK1},    // HS_KNIGHT_WALK4
    {HSPR_KNIG, 4, 10, NULL/*A_FaceTarget*/, HS_KNIGHT_ATK2},       // HS_KNIGHT_ATK1
    {HSPR_KNIG, 5, 8, NULL/*A_FaceTarget*/, HS_KNIGHT_ATK3},        // HS_KNIGHT_ATK2
    {HSPR_KNIG, 6, 8, NULL/*A_KnightAttack*/, HS_KNIGHT_ATK4},      // HS_KNIGHT_ATK3
    {HSPR_KNIG, 4, 10, NULL/*A_FaceTarget*/, HS_KNIGHT_ATK5},       // HS_KNIGHT_ATK4
    {HSPR_KNIG, 5, 8, NULL/*A_FaceTarget*/, HS_KNIGHT_ATK6},        // HS_KNIGHT_ATK5
    {HSPR_KNIG, 6, 8, NULL/*A_KnightAttack*/, HS_KNIGHT_WALK1},     // HS_KNIGHT_ATK6
    {HSPR_KNIG, 7, 3, NULL, HS_KNIGHT_PAIN2},       // HS_KNIGHT_PAIN1
    {HSPR_KNIG, 7, 3, NULL/*A_Pain*/, HS_KNIGHT_WALK1},     // HS_KNIGHT_PAIN2
    {HSPR_KNIG, 8, 6, NULL, HS_KNIGHT_DIE2},        // HS_KNIGHT_DIE1
    {HSPR_KNIG, 9, 6, NULL/*A_Scream*/, HS_KNIGHT_DIE3},    // HS_KNIGHT_DIE2
    ...
    {HSPR_SPAX, 32768, 3, NULL/*A_ContMobjSound*/, HS_SPINAXE2},    // HS_SPINAXE1
    {HSPR_SPAX, 32769, 3, NULL, HS_SPINAXE3},       // HS_SPINAXE2
    {HSPR_SPAX, 32770, 3, NULL, HS_SPINAXE1},       // HS_SPINAXE3
    {HSPR_SPAX, 32771, 6, NULL, HS_SPINAXEX2},      // HS_SPINAXEX1
    {HSPR_SPAX, 32772, 6, NULL, HS_SPINAXEX3},      // HS_SPINAXEX2
    {HSPR_SPAX, 32773, 6, NULL, HS_NULL},   // HS_SPINAXEX3
    {HSPR_RAXE, 32768, 5, NULL/*A_DripBlood*/, HS_REDAXE2}, // HS_REDAXE1
    {HSPR_RAXE, 32769, 5, NULL/*A_DripBlood*/, HS_REDAXE1}, // HS_REDAXE2
    {HSPR_RAXE, 32770, 6, NULL, HS_REDAXEX2},       // HS_REDAXEX1
    {HSPR_RAXE, 32771, 6, NULL, HS_REDAXEX3},       // HS_REDAXEX2
    {HSPR_RAXE, 32772, 6, NULL, HS_NULL},   // HS_REDAXEX3
    {HSPR_SRCR, 0, 10, NULL/*A_Look*/, HS_SRCR1_LOOK2},     // HS_SRCR1_LOOK1
    {HSPR_SRCR, 1, 10, NULL/*A_Look*/, HS_SRCR1_LOOK1},     // HS_SRCR1_LOOK2
    ...
    {HSPR_SRCR, 16, 7, NULL/*A_FaceTarget*/, HS_SRCR1_ATK2},        // HS_SRCR1_ATK1
    {HSPR_SRCR, 17, 6, NULL/*A_FaceTarget*/, HS_SRCR1_ATK3},        // HS_SRCR1_ATK2
    {HSPR_SRCR, 18, 10, NULL/*A_Srcr1Attack*/, HS_SRCR1_WALK1},     // HS_SRCR1_ATK3
    {HSPR_SRCR, 18, 10, NULL/*A_FaceTarget*/, HS_SRCR1_ATK5},       // HS_SRCR1_ATK4
    {HSPR_SRCR, 16, 7, NULL/*A_FaceTarget*/, HS_SRCR1_ATK6},        // HS_SRCR1_ATK5
    {HSPR_SRCR, 17, 6, NULL/*A_FaceTarget*/, HS_SRCR1_ATK7},        // HS_SRCR1_ATK6
    {HSPR_SRCR, 18, 10, NULL/*A_Srcr1Attack*/, HS_SRCR1_WALK1},     // HS_SRCR1_ATK7
    {HSPR_SRCR, 4, 7, NULL, HS_SRCR1_DIE2}, // HS_SRCR1_DIE1
    {HSPR_SRCR, 5, 7, NULL/*A_Scream*/, HS_SRCR1_DIE3},     // HS_SRCR1_DIE2
    ...
    {HSPR_FX14, 32768, 6, NULL, HS_SRCRFX1_2},      // HS_SRCRFX1_1
    {HSPR_FX14, 32769, 6, NULL, HS_SRCRFX1_3},      // HS_SRCRFX1_2
    {HSPR_FX14, 32770, 6, NULL, HS_SRCRFX1_1},      // HS_SRCRFX1_3
    {HSPR_FX14, 32771, 5, NULL, HS_SRCRFXI1_2},     // HS_SRCRFXI1_1
    {HSPR_FX14, 32772, 5, NULL, HS_SRCRFXI1_3},     // HS_SRCRFXI1_2
    {HSPR_FX14, 32773, 5, NULL, HS_SRCRFXI1_4},     // HS_SRCRFXI1_3
    {HSPR_FX14, 32774, 5, NULL, HS_SRCRFXI1_5},     // HS_SRCRFXI1_4
    {HSPR_FX14, 32775, 5, NULL, HS_NULL},   // HS_SRCRFXI1_5
    ...
    {HSPR_SOR2, 12, 10, NULL/*A_Look*/, HS_SOR2_LOOK2},     // HS_SOR2_LOOK1
    {HSPR_SOR2, 13, 10, NULL/*A_Look*/, HS_SOR2_LOOK1},     // HS_SOR2_LOOK2
    {HSPR_SOR2, 12, 4, NULL/*A_Chase*/, HS_SOR2_WALK2},     // HS_SOR2_WALK1
    {HSPR_SOR2, 13, 4, NULL/*A_Chase*/, HS_SOR2_WALK3},     // HS_SOR2_WALK2
    {HSPR_SOR2, 14, 4, NULL/*A_Chase*/, HS_SOR2_WALK4},     // HS_SOR2_WALK3
    {HSPR_SOR2, 15, 4, NULL/*A_Chase*/, HS_SOR2_WALK1},     // HS_SOR2_WALK4
    {HSPR_SOR2, 16, 3, NULL, HS_SOR2_PAIN2},        // HS_SOR2_PAIN1
    {HSPR_SOR2, 16, 6, NULL/*A_Pain*/, HS_SOR2_WALK1},      // HS_SOR2_PAIN2
    {HSPR_SOR2, 17, 9, NULL/*A_Srcr2Decide*/, HS_SOR2_ATK2},        // HS_SOR2_ATK1
    {HSPR_SOR2, 18, 9, NULL/*A_FaceTarget*/, HS_SOR2_ATK3}, // HS_SOR2_ATK2
    ...
    {HSPR_FX16, 32768, 3, NULL/*A_BlueSpark*/, HS_SOR2FX1_2},       // HS_SOR2FX1_1
    {HSPR_FX16, 32769, 3, NULL/*A_BlueSpark*/, HS_SOR2FX1_3},       // HS_SOR2FX1_2
    {HSPR_FX16, 32770, 3, NULL/*A_BlueSpark*/, HS_SOR2FX1_1},       // HS_SOR2FX1_3
    {HSPR_FX16, 32774, 5, NULL/*A_Explode*/, HS_SOR2FXI1_2},        // HS_SOR2FXI1_1
    {HSPR_FX16, 32775, 5, NULL, HS_SOR2FXI1_3},     // HS_SOR2FXI1_2
    {HSPR_FX16, 32776, 5, NULL, HS_SOR2FXI1_4},     // HS_SOR2FXI1_3
    {HSPR_FX16, 32777, 5, NULL, HS_SOR2FXI1_5},     // HS_SOR2FXI1_4
    {HSPR_FX16, 32778, 5, NULL, HS_SOR2FXI1_6},     // HS_SOR2FXI1_5
    {HSPR_FX16, 32779, 5, NULL, HS_NULL},   // HS_SOR2FXI1_6
    {HSPR_FX16, 32771, 12, NULL, HS_SOR2FXSPARK2},  // HS_SOR2FXSPARK1
    {HSPR_FX16, 32772, 12, NULL, HS_SOR2FXSPARK3},  // HS_SOR2FXSPARK2
    {HSPR_FX16, 32773, 12, NULL, HS_NULL},  // HS_SOR2FXSPARK3
    {HSPR_FX11, 32768, 35, NULL, HS_SOR2FX2_2},     // HS_SOR2FX2_1
    {HSPR_FX11, 32768, 5, NULL/*A_GenWizard*/, HS_SOR2FX2_3},       // HS_SOR2FX2_2
    {HSPR_FX11, 32769, 5, NULL, HS_SOR2FX2_2},      // HS_SOR2FX2_3
    {HSPR_FX11, 32770, 5, NULL, HS_SOR2FXI2_2},     // HS_SOR2FXI2_1
    {HSPR_FX11, 32771, 5, NULL, HS_SOR2FXI2_3},     // HS_SOR2FXI2_2
    {HSPR_FX11, 32772, 5, NULL, HS_SOR2FXI2_4},     // HS_SOR2FXI2_3
    {HSPR_FX11, 32773, 5, NULL, HS_SOR2FXI2_5},     // HS_SOR2FXI2_4
    {HSPR_FX11, 32774, 5, NULL, HS_NULL},   // HS_SOR2FXI2_5
    ...
    {HSPR_MNTR, 0, 10, NULL/*A_Look*/, HS_MNTR_LOOK2},      // HS_MNTR_LOOK1
    {HSPR_MNTR, 1, 10, NULL/*A_Look*/, HS_MNTR_LOOK1},      // HS_MNTR_LOOK2
    {HSPR_MNTR, 0, 5, NULL/*A_Chase*/, HS_MNTR_WALK2},      // HS_MNTR_WALK1
    {HSPR_MNTR, 1, 5, NULL/*A_Chase*/, HS_MNTR_WALK3},      // HS_MNTR_WALK2
    {HSPR_MNTR, 2, 5, NULL/*A_Chase*/, HS_MNTR_WALK4},      // HS_MNTR_WALK3
    {HSPR_MNTR, 3, 5, NULL/*A_Chase*/, HS_MNTR_WALK1},      // HS_MNTR_WALK4
    {HSPR_MNTR, 21, 10, NULL/*A_FaceTarget*/, HS_MNTR_ATK1_2},      // HS_MNTR_ATK1_1
    {HSPR_MNTR, 22, 7, NULL/*A_FaceTarget*/, HS_MNTR_ATK1_3},       // HS_MNTR_ATK1_2
    ...
    {HSPR_MNTR, 24, 4, NULL/*A_FaceTarget*/, HS_MNTR_ATK2_3},       // HS_MNTR_ATK2_2
    {HSPR_MNTR, 25, 9, NULL/*A_MinotaurAtk2*/, HS_MNTR_WALK1},      // HS_MNTR_ATK2_3
    {HSPR_MNTR, 21, 10, NULL/*A_FaceTarget*/, HS_MNTR_ATK3_2},      // HS_MNTR_ATK3_1
    {HSPR_MNTR, 22, 7, NULL/*A_FaceTarget*/, HS_MNTR_ATK3_3},       // HS_MNTR_ATK3_2
    ...
    {HSPR_MNTR, 4, 6, NULL/*A_Pain*/, HS_MNTR_WALK1},       // HS_MNTR_PAIN2
    {HSPR_MNTR, 5, 6, NULL, HS_MNTR_DIE2},  // HS_MNTR_DIE1
    {HSPR_MNTR, 6, 5, NULL, HS_MNTR_DIE3},  // HS_MNTR_DIE2
    {HSPR_MNTR, 7, 6, NULL/*A_Scream*/, HS_MNTR_DIE4},      // HS_MNTR_DIE3
    ...
    {HSPR_FX12, 32768, 6, NULL, HS_MNTRFX1_2},      // HS_MNTRFX1_1
    {HSPR_FX12, 32769, 6, NULL, HS_MNTRFX1_1},      // HS_MNTRFX1_2
    {HSPR_FX12, 32770, 5, NULL, HS_MNTRFXI1_2},     // HS_MNTRFXI1_1
    {HSPR_FX12, 32771, 5, NULL, HS_MNTRFXI1_3},     // HS_MNTRFXI1_2
    {HSPR_FX12, 32772, 5, NULL, HS_MNTRFXI1_4},     // HS_MNTRFXI1_3
    {HSPR_FX12, 32773, 5, NULL, HS_MNTRFXI1_5},     // HS_MNTRFXI1_4
    {HSPR_FX12, 32774, 5, NULL, HS_MNTRFXI1_6},     // HS_MNTRFXI1_5
    {HSPR_FX12, 32775, 5, NULL, HS_NULL},   // HS_MNTRFXI1_6
    {HSPR_FX13, 0, 2, NULL/*A_MntrFloorFire*/, HS_MNTRFX2_1},       // HS_MNTRFX2_1
    {HSPR_FX13, 32776, 4, NULL/*A_Explode*/, HS_MNTRFXI2_2},        // HS_MNTRFXI2_1
    {HSPR_FX13, 32777, 4, NULL, HS_MNTRFXI2_3},     // HS_MNTRFXI2_2
    {HSPR_FX13, 32778, 4, NULL, HS_MNTRFXI2_4},     // HS_MNTRFXI2_3
    {HSPR_FX13, 32779, 4, NULL, HS_MNTRFXI2_5},     // HS_MNTRFXI2_4
    {HSPR_FX13, 32780, 4, NULL, HS_NULL},   // HS_MNTRFXI2_5
    {HSPR_FX13, 32771, 4, NULL, HS_MNTRFX3_2},      // HS_MNTRFX3_1
    {HSPR_FX13, 32770, 4, NULL, HS_MNTRFX3_3},      // HS_MNTRFX3_2
    {HSPR_FX13, 32769, 5, NULL, HS_MNTRFX3_4},      // HS_MNTRFX3_3
    {HSPR_FX13, 32770, 5, NULL, HS_MNTRFX3_5},      // HS_MNTRFX3_4
    {HSPR_FX13, 32771, 5, NULL, HS_MNTRFX3_6},      // HS_MNTRFX3_5
    {HSPR_FX13, 32772, 5, NULL, HS_MNTRFX3_7},      // HS_MNTRFX3_6
    {HSPR_FX13, 32773, 4, NULL, HS_MNTRFX3_8},      // HS_MNTRFX3_7
    {HSPR_FX13, 32774, 4, NULL, HS_MNTRFX3_9},      // HS_MNTRFX3_8
    {HSPR_FX13, 32775, 4, NULL, HS_NULL},   // HS_MNTRFX3_9
    {HSPR_AKYY, 32768, 3, NULL, HS_AKYY2},  // HS_AKYY1
    {HSPR_AKYY, 32769, 3, NULL, HS_AKYY3},  // HS_AKYY2
    {HSPR_AKYY, 32770, 3, NULL, HS_AKYY4},  // HS_AKYY3
    {HSPR_AKYY, 32771, 3, NULL, HS_AKYY5},  // HS_AKYY4
    {HSPR_AKYY, 32772, 3, NULL, HS_AKYY6},  // HS_AKYY5
    {HSPR_AKYY, 32773, 3, NULL, HS_AKYY7},  // HS_AKYY6
    {HSPR_AKYY, 32774, 3, NULL, HS_AKYY8},  // HS_AKYY7
    {HSPR_AKYY, 32775, 3, NULL, HS_AKYY9},  // HS_AKYY8
    {HSPR_AKYY, 32776, 3, NULL, HS_AKYY10}, // HS_AKYY9
    {HSPR_AKYY, 32777, 3, NULL, HS_AKYY1},  // HS_AKYY10
    {HSPR_BKYY, 32768, 3, NULL, HS_BKYY2},  // HS_BKYY1
    {HSPR_BKYY, 32769, 3, NULL, HS_BKYY3},  // HS_BKYY2
    {HSPR_BKYY, 32770, 3, NULL, HS_BKYY4},  // HS_BKYY3
    {HSPR_BKYY, 32771, 3, NULL, HS_BKYY5},  // HS_BKYY4
    {HSPR_BKYY, 32772, 3, NULL, HS_BKYY6},  // HS_BKYY5
    {HSPR_BKYY, 32773, 3, NULL, HS_BKYY7},  // HS_BKYY6
    {HSPR_BKYY, 32774, 3, NULL, HS_BKYY8},  // HS_BKYY7
    {HSPR_BKYY, 32775, 3, NULL, HS_BKYY9},  // HS_BKYY8
    {HSPR_BKYY, 32776, 3, NULL, HS_BKYY10}, // HS_BKYY9
    {HSPR_BKYY, 32777, 3, NULL, HS_BKYY1},  // HS_BKYY10
    {HSPR_CKYY, 32768, 3, NULL, HS_CKYY2},  // HS_CKYY1
    {HSPR_CKYY, 32769, 3, NULL, HS_CKYY3},  // HS_CKYY2
    {HSPR_CKYY, 32770, 3, NULL, HS_CKYY4},  // HS_CKYY3
    {HSPR_CKYY, 32771, 3, NULL, HS_CKYY5},  // HS_CKYY4
    {HSPR_CKYY, 32772, 3, NULL, HS_CKYY6},  // HS_CKYY5
    {HSPR_CKYY, 32773, 3, NULL, HS_CKYY7},  // HS_CKYY6
    {HSPR_CKYY, 32774, 3, NULL, HS_CKYY8},  // HS_CKYY7
    {HSPR_CKYY, 32775, 3, NULL, HS_CKYY9},  // HS_CKYY8
    {HSPR_CKYY, 32776, 3, NULL, HS_CKYY1},  // HS_CKYY9
    ...
    {HSPR_AMG1, 0, 85, NULL/*A_ESound*/, HS_SND_WATERFALL, 0, 0}  // HS_SND_WATERFALL
};
